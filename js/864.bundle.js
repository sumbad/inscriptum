"use strict";(self.webpackChunkinscriptum=self.webpackChunkinscriptum||[]).push([[864,880,432],{3864:(e,o,t)=>{t.r(o),t.d(o,{ListComponent:()=>d});var r=t(745),i=t(3445),p=t(7157),a=t(6201),s=t(577),n=t(1943),l=function(e,o,t,r){var i,p=arguments.length,a=p<3?o:null===r?r=Object.getOwnPropertyDescriptor(o,t):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,o,t,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(a=(p<3?i(a):p>3?i(o,t,a):i(o,t))||a);return p>3&&a&&Object.defineProperty(o,t,a),a};let d=class extends r.yB{constructor(){super(a.Z,!1),this.styles=i.dy`
    <style>
      ${t(7432)}
      ${t(7880)}
    </style>
  `,this._list=[]}set value(e){void 0!==e&&(this._list=e)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.closePopovers.bind(this))}disconnectedCallback(){document.removeEventListener("click",this.closePopovers.bind(this))}render(){if(this._list.length<1)return i.dy``;const e=(e,o=[])=>o.length>0?i.dy`
        ...
        <div class="um-drafts__item">
          ${(o.tags||[]).map((e=>null!=e.link?i.dy`<a href="/${e.link.href}" rel=${(0,s.o)(e.link.rel)}>${e.code}</a>`:e.code))}
          <h6 class="docs-header">${o.preview.title}</h6>
          <div class="row">
            ...
            <div class=${(null===(p=o.preview.image)||void 0===p?void 0:p.length)>0?"ten columns":""}>
              <a class="um-drafts__item-link" href=${o.linkUrl} rel=${(0,s.o)(o.linkRel)}>
                <p class="docs-preview">${(0,n.A)(o.preview.description)}</p>
              </a>
