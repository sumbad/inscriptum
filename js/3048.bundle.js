(self.webpackChunkinscriptum=self.webpackChunkinscriptum||[]).push([[3048,2701,3864,7880,7432,2396,352,4715,495,6381],{3048:(e,t,o)=>{"use strict";o.r(t),o.d(t,{DraftComponent:()=>f});var r=o(745),i=o(5306),n=o(1966),s=o(4615),a=o(6201),p=o(5161),l=o.n(p),d=o(8947),c=(o(3864),o(2701),o(3135)),m=function(e,t,o,r){var i,n=arguments.length,s=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,r);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(n<3?i(s):n>3?i(t,o,s):i(t,o))||s);return n>3&&s&&Object.defineProperty(t,o,s),s},u=function(e,t,o,r){return new(o||(o=Promise))((function(i,n){function s(e){try{p(r.next(e))}catch(e){n(e)}}function a(e){try{p(r.throw(e))}catch(e){n(e)}}function p(e){var t;e.done?i(e.value):(t=e.value,t instanceof o?t:new o((function(e){e(t)}))).then(s,a)}p((r=r.apply(e,t||[])).next())}))};var h;!function(e){e[e.edit=0]="edit",e[e.delete=1]="delete"}(h||(h={}));let f=class extends r.yB{constructor(e=new n.V,t){super(a.Z,!1),this._storageService=e,this._authService=t,this.$={isPreloader:!0,hasAuth:!1},this._authService=new s.e(this._storageService)}connectedCallback(){super.connectedCallback(),this._authService.$authenticated.subscribe((e=>{this.$=Object.assign(Object.assign({},this.$),{hasAuth:Boolean(e)})})),(()=>u(this,void 0,void 0,(function*(){try{return(yield o(9228)(`./${c.v.nodeListFileName}`)).default}catch(e){return yield this._storageService.api.note.getAll()}})))().then((e=>{const t=e.map((e=>({id:e.id,preview:e.preview,linkUrl:e.static_link+"",linkRel:"external",actions:()=>this.$.hasAuth?[{type:h.edit,label:"изменить"}]:[]})));this.$=Object.assign(Object.assign({},this.$),{isPreloader:!1,notes:t})})),d.vz.watch()}render(){return i.dy`
      <um-preloader ?loading=${this.$.isPreloader}>
        <inscriptum-list @action=${this.handleAction.bind(this)} .value=${this.$.notes}></inscriptum-list>
      </um-preloader>
    `}handleAction({detail:e}){switch(e.type){case h.edit:l()("/editor/"+e.id+"/posted")}}};m([(0,r.SB)()],f.prototype,"$",void 0),f=m([(0,r.Qr)("inscriptum-notes")],f)},3864:(e,t,o)=>{"use strict";o.r(t),o.d(t,{ListComponent:()=>u});var r=o(745),i=o(5306),n=o(7157),s=o(6201),a=o(8947),p=o(1436),l=o(6024),d=o(577),c=o(1943),m=function(e,t,o,r){var i,n=arguments.length,s=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,r);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(n<3?i(s):n>3?i(t,o,s):i(t,o))||s);return n>3&&s&&Object.defineProperty(t,o,s),s};a.vI.add(p.gc2,l.r6);let u=class extends r.yB{constructor(){super(s.Z,!1),this.styles=i.dy`
    <style>
      ${o(7432)}
      ${o(7880)}
    </style>
