...
`,this.$={isPreloader:!0},this._authService=new s.a(this._storageService)}connectedCallback(){var e,t;super.connectedCallback(),this._authService.$authenticated.pipe((e=()=>void 0===this.$.drafts,void 0===t&&(t=!1),function(i){return i.lift(new h(e,t))})).subscribe(e=>{e?this._storageService.allDrafts().then(e=>{const t=e.allDrafts.map(e=>{const{content:t,title:i,image:o}=Object(v.b)(e.contents);return{id:e.id,title:i,image:o,content:t,linkUrl:"/editor/"+e.id,actions:[{label:"удалить",type:b.delete}]}});this.$={isPreloader:!1,drafts:t}}):null!==e&&this._authService.login()}),u.a.watch()}render(){return r.e`
    ...
    <um-preloader loading=${this.$.isPreloader}>
      ...
      <inscriptum-list @action=${this.handleAction.bind(this)} .value=${Object(n.a)(this.$.drafts)}></inscriptum-list>
    </um-preloader>
    `}async handleBtnCreateNewDraft(){const e=await this._authService.userInfo,t=(await this._storageService.createDraft(e.name||e.email||"")).createDraft.id;c()("/editor/"+t)}handleBtnExportAllDrafts(e){e.preventDefault();const t=JSON.stringify(this.$.drafts),i=document.createElement("a"),o=new Blob([t],{type:"application/octet-stream"});i.href=window.URL.createObjectURL(o),i.download="drafts.json",i.click()}handleAction({detail:e}){switch(e.type){case b.delete:this._deleteDraft(e.id)}}_deleteDraft(e){this._storageService.deleteDraft(e).then(e=>{this.$={...this.$,drafts:this.$.drafts&&this.$.drafts.filter(t=>t.id!==e.deleteDraft.id)}})}};x([Object(o.e)()],w.prototype,"$",void 0),w=x([Object(o.b)("inscriptum-drafts")],w)},40:function(e,t){e.exports=".um-drafts__submenu{display:flex;flex-direction:row-reverse;padding-top:10px;border-bottom:1px solid #eee}.um-drafts__export-all{margin:0 0 10px 10px;stroke:#ffffff;stroke-width:30px;color:#bbb}.um-drafts__export-all:hover{color:#888;cursor:pointer}"},58:function(e,t,i){"use strict";i.r(t),i.d(t,"ListComponent",(function(){return h}));var o=i(23),r=i(13),n=i(163),a=i(32),s=i(107),l=i(123),p=i(154),c=i(153),d=i(34),m=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};s.b.add(l.a,p.a);let h=class extends o.a{constructor(){super(a.a,!1),this.styles=r.e`
    <style>
      ${i(102)}
      ${i(103)}
    </style>
  `,this._list=[]}set value(e){void 0!==e&&(this._list=e)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.closePopovers.bind(this))}disconnectedCallback(){document.removeEventListener("click",this.closePopovers.bind(this))}render(){if(this._list.length<1)return r.e``;const e=(e,t=[])=>t.length>0?r.e`
    ...
    `}dispatchAction(e){this.dispatchEvent(new CustomEvent("action",{detail:e}))}openPopover(e){e.preventDefault(),this.closePopovers();const t=this.querySelector("#"+(e.target||{popover:{}}).dataset.popover);null!==t&&t.classList.add("open"),e.stopImmediatePropagation()}closePopovers(){this.querySelectorAll(".popover.open").forEach(e=>{e.classList.remove("open")})}};m([Object(o.e)()],h.prototype,"_list",void 0),h=m([Object(o.b)("inscriptum-list")],h)}}]);