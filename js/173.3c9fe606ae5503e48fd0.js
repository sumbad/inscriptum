"use strict";(self.webpackChunkinscriptum=self.webpackChunkinscriptum||[]).push([[173],{1173:(t,e,o)=>{o.r(e),o.d(e,{draftElement:()=>io});var n=o(1640),i=o(9890),r=o(3619),a=o(9491),l=o(9725),s=o(4860),c=o(7012),d=o(3853),p=o(669);const u=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
    ...
    `,this)}));var Jt=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};window.requestIdleCallback=window.requestIdleCallback||function(t){setTimeout(t,1)};class Kt{set penColor(t){this._penColor=t,null!=this.penEl&&(this.penEl.style.backgroundColor=this._penColor)}set penSize(t){if(this._penSize=t,null!=this.penEl){const t=Math.floor(this._penSize);this.penEl.style.width=`${t}px`,this.penEl.style.height=`${t}px`}}get isEmpty(){return 0===this.strokeHistory.length}constructor(t,e){this.canvas=t,this.canvasRect=this.canvas.getBoundingClientRect(),this.isMousedown=!1,this.points=[],this.strokeHistory=[],this._defaultOptions={backgroundColor:"rgba(0,0,0,0)"},this.lineWidth=0,this._penColor="black",this._penSize=1,this._mouseout=()=>{this.penEl.style.left="-100px",this.penEl.style.top="-100px"},this._startDraw=t=>{const e=this._prepareEvent(t);null!=e&&(t.preventDefault(),this.isMousedown=!0,this.lineWidth=8*Math.log(e.pressure*this._penSize+1),this.context.lineWidth=this.lineWidth,this.canvasRect=this.canvas.getBoundingClientRect(),this.points.push(this._createPoint(e.drawEvent,this.lineWidth)),this._draw(this.points))},this._continueDraw=t=>{const e=this._prepareEvent(t);if(null==e)return;let o=8*Math.log(e.pressure*this._penSize+1);o+=.5*this.lineWidth,this.lineWidth=o;const n=this._createPoint(e.drawEvent,o);this.penEl.style.left=n.x-this._penSize/2-1+"px",this.penEl.style.top=n.y-this._penSize/2-1+"px",this.isMousedown&&(this.points.push(n),this._draw(this.points))},this._stopDraw=()=>{this.isMousedown=!1,this.lineWidth=0,requestIdleCallback((()=>{this.points.length>0&&(this.strokeHistory.push([...this.points]),this.points=[])}))},this.context=t.getContext("2d"),this._options=Object.assign(Object.assign({},this._defaultOptions),e),this.context.fillStyle=this._options.backgroundColor,this.context.clearRect(0,0,this.canvas.width,this.canvas.height),this.context.fillRect(0,0,this.canvas.width,this.canvas.height);const o="ontouchstart"in document,n=/Macintosh/.test(navigator.userAgent)&&o;null==window.PointerEvent||n?(this._handleMouseEvents(),o&&this._handleTouchEvents()):this._handlePointerEvents(),this.canvas.addEventListener("mouseout",this._mouseout);const i=Math.floor(this._penSize);this.penEl=document.createElement("div"),this.penEl.style.width=`${i}px`,this.penEl.style.height=`${i}px`,this.penEl.style.border="1px solid gray",this.penEl.style.borderRadius="50%",this.penEl.style.position="absolute",this.penEl.style.pointerEvents="none",this.penEl.style.backgroundColor=this._penColor,this.penEl.style.left="-100px",this.penEl.style.top="-100px",t.after(this.penEl),this.setMode("pencil")}restore(t=this.strokeHistory){for(const e of t){this.context.beginPath();let t=[];e.map((e=>{t.push(e),this._draw(t)}))}}setMode(t){switch(t){case"erase":this.context.globalCompositeOperation="destination-out",this.penEl.style.backgroundColor=this._defaultOptions.backgroundColor,this.canvas.style.cursor="none";break;case"pencil":this.context.globalCompositeOperation="source-over",this.penEl.style.backgroundColor=this._penColor,this.canvas.style.cursor="crosshair"}}clear(){this.dataUrlImage=null,this.context.fillStyle=this._options.backgroundColor,this.context.clearRect(0,0,this.canvas.width,this.canvas.height),this.context.fillRect(0,0,this.canvas.width,this.canvas.height)}reset(){this.lineWidth=0,this.isMousedown=!1,this.points=[],this.strokeHistory=[]}toDataURL(t="image/png",e){return this.canvas.toDataURL(t,e)}fromDataURL(t,e={}){return Jt(this,void 0,void 0,(function*(){this._options=Object.assign(Object.assign({},this._options),{backgroundColor:this._defaultOptions.backgroundColor}),this.clear(),yield new Promise(((o,n)=>{const i=new Image,r=e.ratio||window.devicePixelRatio||1,a=e.width||this.canvas.width/r,l=e.height||this.canvas.height/r,s=e.xOffset||0,c=e.yOffset||0;i.onload=()=>{const t=this.context.globalCompositeOperation;this.context.globalCompositeOperation="source-over",this.context.drawImage(i,s,c,a,l),this.context.globalCompositeOperation=t,o()},i.onerror=t=>{n(t)},i.crossOrigin="anonymous",i.src=t})),this.dataUrlImage={dataUrl:t,options:e}}))}undoDraw(){return Jt(this,void 0,void 0,(function*(){const t=this.context.globalCompositeOperation;this.strokeHistory.pop(),this.context.clearRect(0,0,this.canvas.width,this.canvas.height),null!=this.dataUrlImage&&(yield this.fromDataURL(this.dataUrlImage.dataUrl,this.dataUrlImage.options)),this.strokeHistory.map((t=>{this.context.beginPath();let e=[];t.map((t=>{e.push(t),this._draw(e)}))})),this.context.globalCompositeOperation=t}))}_draw(t){this.context.lineCap="round",this.context.lineJoin="round";const e=t.length-1,o=t[e-1],n=t[e];if(this.context.strokeStyle=n.color,this.context.globalCompositeOperation=n.globalCompositeOperation,t.length>=3){const t=(n.x+o.x)/2,e=(n.y+o.y)/2;this.context.lineWidth=o.lineWidth,this.context.quadraticCurveTo(o.x,o.y,t,e),this.context.stroke(),this.context.beginPath(),this.context.moveTo(t,e)}else this.context.lineWidth=n.lineWidth,this.context.beginPath(),this.context.moveTo(n.x,n.y),this.context.stroke()}_prepareEvent(t){let e,o=0,n="mouse";if("touches"in t){if(1!==t.touches.length)return null;{t.preventDefault();const i=t.touches[0];o=i.force,n=i.touchType,e=i}}else"pressure"in t&&(o=t.pressure/2.5,n=t.pointerType),e=t;if(["direct","mouse",void 0].includes(n)&&0===o&&(o=this._penSize/5),null==this.inputType||["pen","stylus"].includes(n))this.inputType=n,"stylus"===n&&"source-over"===this.context.globalCompositeOperation?this.penEl.style.display="none":this.penEl.style.display="block";else if(this.inputType!=n)return null;return{pressure:o,drawEvent:e,inputType:n}}_createPoint(t,e){return{x:t.clientX-this.canvasRect.left,y:t.clientY-this.canvasRect.top,lineWidth:e,color:this._penColor,globalCompositeOperation:this.context.globalCompositeOperation}}_handlePointerEvents(){this.canvas.addEventListener("pointerdown",this._startDraw),this.canvas.addEventListener("pointermove",this._continueDraw),document.addEventListener("pointerup",this._stopDraw)}_handleMouseEvents(){this.canvas.addEventListener("mousedown",this._startDraw),this.canvas.addEventListener("mousemove",this._continueDraw),document.addEventListener("mouseup",this._stopDraw)}_handleTouchEvents(){this.canvas.addEventListener("touchstart",this._startDraw),this.canvas.addEventListener("touchmove",this._continueDraw),this.canvas.addEventListener("touchend",this._stopDraw)}destroy(){this.canvas.removeEventListener("mouseout",this._mouseout),this.canvas.removeEventListener("pointerdown",this._startDraw),this.canvas.removeEventListener("pointermove",this._continueDraw),document.removeEventListener("pointerup",this._stopDraw),this.canvas.removeEventListener("mousedown",this._startDraw),this.canvas.removeEventListener("mousemove",this._continueDraw),document.removeEventListener("mouseup",this._stopDraw),this.canvas.removeEventListener("touchstart",this._startDraw),this.canvas.removeEventListener("touchmove",this._continueDraw),this.canvas.removeEventListener("touchend",this._stopDraw)}}const Xt=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
      ...
      `,this)}));var ne=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};const ie=Yt(),re=Wt(),ae=Ut(),le=Vt(),se=Xt(),ce=Qt(),de=te(),pe=ee(),ue=oe(),he=(0,i.EG)({props:{data:i.p.req(),mode:i.p.opt()}})((function*(t){var e,o,i,r;const s=(0,a.V)(),c=(0,a.V)();let p,u,h=t.data,f=t.mode,g=Math.max(window.devicePixelRatio||1,1),m=null!==(o=null===(e=h.options)||void 0===e?void 0:e.height)&&void 0!==o?o:0,v=null!==(r=null===(i=h.options)||void 0===i?void 0:i.width)&&void 0!==r?r:0,y=1,w=1.2,x="#878787",_="#f0eade";const k=()=>{const t=s.value,e=c.value;if(null==t||null==e)throw new Error("Can not find a canvas element!");if(p=e.getContext("2d"),null==p)throw new Error("Can not find a canvas context!");const o=v,n=m;m=Math.max(t.getBoundingClientRect().height,window.innerHeight,n),v=Math.max(t.getBoundingClientRect().width,o),e.height=m,e.width=v,e.style.height=`${m}px`,e.style.width=`${v}px`,t.style.height=`${m}px`,this.style.height=`${m}px`,g=Math.max(window.devicePixelRatio||1,1),e.width=e.offsetWidth*g,e.height=e.offsetHeight*g,p.scale(g,g),null==u&&(u=new Kt(e),u.penColor=x,u.penSize=w)},$=(t=!0)=>ne(this,void 0,void 0,(function*(){if(null!=u){if(u.setMode("pencil"),null!=(null==h?void 0:h.imgBase64)&&null!=(null==h?void 0:h.options)){const t=h.options,e=`${t.type},${h.imgBase64}`;u.context.globalAlpha=y,yield u.fromDataURL(e,{height:t.height,width:t.width,ratio:g})}else u.clear();u.context.globalAlpha=1,t?u.restore():u.reset()}})),M=()=>{if(null==u||u.isEmpty)return alert("Please draw something.");null!=(null==h?void 0:h.id)&&function(t,e,o){Dt(this,void 0,void 0,(function*(){const[n,i]=e.split(",");return yield(0,jt.G)((()=>Dt(this,void 0,void 0,(function*(){const{update_margin_by_pk:e}=yield(0,b.S)().saveMargin({id:t,options:Object.assign(Object.assign({},o),{type:n}),img:i,updated_at:(new Date).toISOString()});if(null!=e)return l.Z.dispatch({type:It.o.SAVE_DONE,payload:e}),l.Z.dispatch({type:St.C.SHOW,payload:{status:"success",type:"top-right",message:"Successfully saved"}}),e;l.Z.dispatch({type:It.o.SAVE_FAIL,payload:{id:t,error:{message:`The Margin ${t} has not been saved!`}}})}))))}))}(h.id,u.toDataURL(),{height:m,width:v,ratio:g})},P=()=>{null!=h.id&&Ht(h.id),null!=u&&u.clear(),null!=p&&(p.font="26px sans-serif",p.fillStyle="#CCCCCC",p.fillText("loading...",50,100))};function E(){null!=u&&u.setMode("erase")}const C=()=>{!function(t){Dt(this,void 0,void 0,(function*(){l.Z.dispatch({type:It.o.LOAD_DONE,payload:{id:t.id,pageId:t.pageId}})}))}(h)};function A(t){if(null!=(null==t?void 0:t.currentTarget)&&null!=u){const e=t.currentTarget;y=Number(e.value)}}function j(){null!=u&&u.undoDraw()}const z=t=>{null!=u&&(u.penColor=t.detail.value,u.setMode("pencil"),this.next())},L=t=>{if(null!=u&&null!=(null==t?void 0:t.currentTarget)){const e=t.currentTarget;w=Number(e.value),u.penSize=w}},T=()=>{null!=u&&u.setMode("pencil")};window.onresize=()=>{k(),$()},requestAnimationFrame((()=>{k(),$()}));try{for(;;)Object.is(h,t.data)||(h=t.data,$(!1)),f!==t.mode&&("full"!=t.mode&&"full"!=f&&(k(),$()),f=t.mode),t=yield(0,n.sY)(n.dy`
          ...
          <div style=${d.iv`
            ...
            <button class="fab-button" @click=${j} style=${d.iv`
                margin-top: 0.7rem;
              `}>
              ${ue({})}
            </button>
          </div>
        `,this)}finally{null==u||u.destroy()}}));var fe=o(6925);const ge=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
      ...
      `,this)}));var be=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};he("sketch-pad");const me=Bt(),ve=Rt(),ye=Gt(),we=Ft(),xe=qt(),_e=ge(),ke=(0,i.EG)({props:{pageId:i.p.req(),marginId:i.p.opt(),onchangeMarginMode:i.p.opt()}})((function*(t){var e;const i=this.attachShadow({mode:"open"}),r=[];let a,c=Nt,p=null!=t.marginId?"hide":"empty";const u=l.Z.$.pipe((0,fe.Z)(It.o),(0,g.h)((e=>e.type!==It.o.CREATE_FAIL&&e.payload.id===t.marginId))),h=t=>()=>be(this,void 0,void 0,(function*(){const e=i.host;switch(t){case"expand":e.style.position="absolute",e.style.borderLeft="none";break;case"full":e.style.borderLeft="none",yield function(t){return be(this,void 0,void 0,(function*(){"requestFullscreen"in t&&null==document.fullscreenElement?yield t.requestFullscreen():"function"==typeof t.webkitRequestFullscreen&&(yield t.webkitRequestFullscreen())}))}(e);break;case"collapse":e.style.position="relative",e.style.borderLeft="solid 1px var(--light-grey)",yield $e();break;default:e.style.borderLeft="none",e.style.position="relative",yield $e()}p=t,this.dispatchEvent(new CustomEvent("changeMarginMode",{detail:{mode:p}})),this.next()})),f=()=>{var e;null==(null===(e=null==c?void 0:c.data)||void 0===e?void 0:e.id)&&function(t){Dt(this,void 0,void 0,(function*(){return yield(0,jt.G)((()=>Dt(this,void 0,void 0,(function*(){const{insert_margin_one:e}=yield(0,b.S)().createMargin({page_id:t,created_at:(new Date).toISOString()});if(null!=(null==e?void 0:e.id))return l.Z.dispatch({type:It.o.CREATE_DONE,payload:{id:e.id,pageId:t}}),e;l.Z.dispatch({type:It.o.CREATE_FAIL,payload:{pageId:t,error:{massage:`Can not create a new Margin for Page ${t}!`}}})}))))}))}(t.pageId)};r.push(l.Z.$.pipe((0,g.h)((t=>t.type===s.u.FULLSCREEN_CHANGED))).subscribe((t=>{t.type===s.u.FULLSCREEN_CHANGED&&(t.payload.isFullscreen&&"full"!==p&&(p="full",this.next()),t.payload.isFullscreen||"full"!==p||(p="collapse",this.next()))})));try{for(;;){null!=t.marginId&&t.marginId!==(null===(e=c.data)||void 0===e?void 0:e.id)&&(null==a||a.unsubscribe(),a=u.subscribe((t=>{c=Zt(c,t),this.next()})),"empty"===p&&h("collapse")(),Ht(t.marginId));let r=n.dy``;switch(p){case"empty":r=n.dy`<button class="btn btn_icon btn__first" title="create new margin" @click=${f}>
              ${_e({})}
        ...
        `,i)}}finally{r.forEach((t=>t.unsubscribe())),null==a||a.unsubscribe()}}));function $e(){return be(this,void 0,void 0,(function*(){"exitFullscreen"in document&&null!=document.fullscreenElement?yield document.exitFullscreen():"function"==typeof document.webkitExitFullscreen&&(yield document.webkitExitFullscreen())}))}const Me=d.iv`
  :host {
    display: inline-flex;
    align-items: center;
    flex-direction: row;
...
`,Pe=(0,i.EG)({props:{label:i.p.req(),value:i.p.req(),isFolded:i.p.req(),change:i.p.req()}})((function*(t){const e=this.attachShadow({mode:"open"});let o=t;(0,d.A_)(Me,e);const i=()=>{t.change(t.value,!o.isFolded)};for(;;)Object.is(t,o)||(o=t),t=yield(0,n.sY)(n.dy`
      ...
      `,e)})),Ee=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
      ...
      `,this)})),Ce=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
      ...
      `,this)}));var Ae=o(9917),je=o(1545),ze=o(2006),Le=o(2965),Te=o(4978),Oe=o(2237),Se=o(9878),Ie=o(8225),De=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};function He(t){return t.pipe((0,ze.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVE,payload:{pageId:t.pageId,draftId:t.draftId}})})),(0,Le.b)(Ct.v.isDevMode?3e3:1e4),(0,ze.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVING,payload:{pageId:t.pageId,draftId:t.draftId}})})),(0,Te.w)((t=>(0,Ae.P)((()=>function(t,e,o){return De(this,void 0,void 0,(function*(){return yield(0,jt.G)((()=>De(this,void 0,void 0,(function*(){return yield(0,b.S)().updatePageById({id:t,content:o,updated_at:(new Date).toISOString()}),{pageId:t,draftId:e,content:o}}))))}))}(t.pageId,t.draftId,t.content))).pipe((0,ze.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVE_DONE,payload:t})})),(0,Oe.a)((0,Ie.W)()),(0,Se.K)((e=>(l.Z.dispatch({type:s.u.PAGE_SAVE_FAIL,payload:{draftId:t.draftId,pageId:t.pageId,error:e}}),je.E)))))))}function Ne(t,e){return e.type===It.o.CREATE_DONE?(null!=t.data&&(t.data.margins=[{id:e.payload.id},...t.data.margins]),t):t}var Ze=o(943),Be=o(6716);const Re=(0,i.EG)({props:{editor:i.p.req(),className:i.p.opt(),tippyOptions:i.p.opt(),pluginKey:i.p.opt(),shouldShow:i.p.opt()}})((function*(t){var e;const i=null!==(e=t.pluginKey)&&void 0!==e?e:Ze.NM.options.pluginKey,r=new Be.x;let a=0,l=null,s=t.editor;const c=this.attachShadow({mode:"open"});(0,d.A_)(o(5484)+o(4891)+d.iv`
        .is-active {
          background: #000;
          color: #fff;
        }
      `,c);const p=({transaction:t})=>{t.steps.length>0?(l=Fe(s),this.next()):t.selection.empty?(l=null,this.next()):r.next()},u=()=>{console.log("useEffect bubbleMenuElement"),cancelAnimationFrame(a),a=requestAnimationFrame((()=>{s.registerPlugin((0,Ze.q3)({editor:s,pluginKey:i,element:this.firstElementChild,shouldShow:t.shouldShow,tippyOptions:Object.assign(Object.assign({},t.tippyOptions),{theme:"light-border",appendTo:c,duration:200})}))})),s.on("transaction",p),r.pipe((0,Le.b)(100)).subscribe((()=>{l=Fe(s),this.next()}))};try{const e=t;for(u();;)Object.is(e,t)||u(),t=yield(0,n.sY)(n.dy`<div class=${t.className} style=${d.iv`
            visibility: 'hidden';
          `}>
          ${l}
        </div>`,this)}finally{console.log("DESTROY bubbleMenuElement"),r.unsubscribe(),cancelAnimationFrame(a),null!=s&&(s.off("transaction",p),s.unregisterPlugin(i))}})),Ge=["topicTitle"];function Fe(t){const e=t.state.selection;return e instanceof Y.qv&&"figure"===e.node.type.name?n.dy`
        ...
        `:e instanceof Y.Bs&&(Ge.includes(e.$from.parent.type.name)||Ge.includes(e.$to.parent.type.name))?null:[B.ZP.name,R.Z.name,F.Z.name,G.Z.name].includes(e.$from.parent.type.name)?n.dy`
    ...
    `}var qe=o(3040);const Ye=(0,i.EG)({props:{editor:i.p.req()}})((function*(t){for(requestAnimationFrame((()=>{t.editor.registerPlugin((0,qe.JF)({editor:t.editor,element:this.firstElementChild,pluginKey:qe.AH.options.pluginKey,shouldShow:({state:t})=>{const{selection:e}=t,{$anchor:o,empty:n}=e,i=1===o.depth,r=o.parent.isTextblock&&!o.parent.type.spec.code&&!o.parent.textContent;return!!(n&&i&&r)},tippyOptions:{interactive:!0,placement:"left",arrow:!1,zIndex:0}})),this.style.zIndex="0"}));;)yield(0,n.sY)(n.dy`<div>
      ...
      </div>`,this)})),Ue=(Re("inscriptum-redactor-bubble-menu"),Ye("inscriptum-redactor-floating-menu"),(0,i.EG)({props:{content:i.p.req(),cbOnUpdateContent:i.p.req(),isTitle:i.p.req(),disable:i.p.req()}})((function*(t){var e,i;const r=(0,a.V)();let l=0,s=null;const c=()=>{cancelAnimationFrame(l),l=requestAnimationFrame((()=>{const e=r.value;if(null!=e){const o=t.content;s=function(t,e,o=!1,n){return new v.ML({element:t,content:e,onUpdate:null==n?void 0:n.onUpdate,extensions:Pt(o)})}(e,o,t.isTitle,{onUpdate:({editor:e})=>{t.cbOnUpdateContent(e.getJSON())}}),this.next()}}))};try{let d=t;for(c();;)Object.is(t.content,d.content)&&Object.is(t.isTitle,d.isTitle)||c(),null==s||Object.is(t.disable,d.disable)||s.setEditable(!t.disable),d=t,t=yield(0,n.sY)(n.dy`<div class="redactor">
          <style>${o(1784)}</style>
          <article .ref=${(0,a.i)(r)} class="redactor__article"></article>
          ${null!=s?n.dy`
            ...
            `:""}
        </div>`,this)}finally{console.log("DESTROY redactorElement"),null===(i=null===(e=r.value)||void 0===e?void 0:e.firstChild)||void 0===i||i.remove(),cancelAnimationFrame(l),null!=s&&s.destroy()}})));var We=o(3074);Ue("inscriptum-redactor"),ke("inscriptum-margin"),Pe("inscriptum-folding");const Ve=Ee(),Je=Ce(),Ke=(0,i.EG)({props:{page:i.p.req(),header:i.p.opt()}})((function*(t){let e={data:t.page,isLoading:!1},i=t.page.content,r=!!t.page.isFolded,a="hide";const c=new Be.x,p=He(c),u=new Be.x,h=function(t){return t.pipe((0,Te.w)((t=>(0,Ae.P)((()=>De(this,void 0,void 0,(function*(){return(0,jt.G)((()=>De(this,void 0,void 0,(function*(){var e;const{insert_page_one:o,update_page:n}=yield(0,b.S)().addPageToDraft({draft_id:t.draftId,order:t.order,created_at:(new Date).toISOString()});if(null==o)throw new Error("newPage == null");const i=null!==(e=null==n?void 0:n.returning)&&void 0!==e?e:[];return{draftId:t.draftId,newPage:o,updatedPages:i}}))))})))))),(0,ze.b)((t=>{const{draftId:e,updatedPages:o,newPage:n}=t;l.Z.dispatch({type:s.u.DRAFT_ADD_PAGE_DONE,payload:{draftId:e,newPage:Object.assign(Object.assign({},n),{content:null==n?void 0:n.content,draftId:e}),updatedPages:o}})})))}(u),f=new Be.x,m=function(t){return t.pipe((0,Te.w)((t=>(0,Ae.P)((()=>De(this,void 0,void 0,(function*(){return(0,jt.G)((()=>De(this,void 0,void 0,(function*(){var e;const{update_page_by_pk:o,update_page:n}=yield(0,b.S)().deletePage({id:t.pageId,ended_at:(new Date).toISOString(),draft_id:t.draftId,order:t.order}),i=null!==(e=null==n?void 0:n.returning)&&void 0!==e?e:[],r={id:null==o?void 0:o.id,order:t.order};return{draftId:t.draftId,deletedPage:r,updatedPages:i}}))))})))))),(0,ze.b)((t=>{l.Z.dispatch({type:s.u.DRAFT_DELETE_PAGE_DONE,payload:{draftId:t.draftId,deletedPage:t.deletedPage,updatedPages:t.updatedPages}})})))}(f),v=(y=t.page.id,l.Z.$.pipe((0,fe.Z)(It.o),(0,g.h)((t=>t.type===It.o.CREATE_DONE&&t.payload.pageId===y)))).pipe((0,We.R)(Ne,{data:t.page,isLoading:!1})).subscribe((t=>{e=t,this.next()}));var y;const w=l.Z.$.pipe((0,g.h)((t=>{var o;return t.type===s.u.PAGE_FOLDED&&t.payload.pageId===(null===(o=e.data)||void 0===o?void 0:o.id)}))).subscribe((t=>{t.type===s.u.PAGE_FOLDED&&(r=t.payload.folded)}));v.add(p.subscribe((t=>{null!=e.data&&(e.data.content=t.content)}))),v.add(h.subscribe()),v.add(m.subscribe()),v.add(w);const x=t=>{null!=e.data&&c.next({pageId:e.data.id,draftId:e.data.draftId,content:t})},_=t=>()=>{var o;null!=(null===(o=e.data)||void 0===o?void 0:o.draftId)&&u.next({draftId:e.data.draftId,order:t})},k=()=>{null!=e.data&&f.next({draftId:e.data.draftId,pageId:e.data.id,order:e.data.order})},$=t=>{a=t.detail.mode,this.next()},M=t=>{r=t,e.data&&(i=e.data.content),this.next()};try{for(;;){let l=n.dy``;if(null!=e.data){const s=n.dy`<div class="page__controls">
            <div>
              <button class="btn btn_icon" title="add a new page" @click=${_(e.data.order+1)}>
                ${Ve({})}
              </button>
              ${e.data.order>0?n.dy`<button class="btn btn_icon" title="delete this page" @click=${k}>
                  ${Je({})}
                </button>`:null}
            </div>
          </div>`;l=n.dy`<div id=${`page_${e.data.id}`}>
            <style>${o(3384)}</style>
            <inscriptum-folding .label=${e.data.order>0?String(e.data.order):""} .value=${e.data.id} .isFolded=${r} .change=${(t,e)=>M(e)}></inscriptum-folding>
            ${r?n.dy`
                <span class="pageContent_collapsed" @click=${()=>M(!1)}>
                  ${t.header&&t.header.trim().length>0?t.header:"..."}
                </span>
                ${s}
              `:n.dy`<div class="row" style=${d.iv`
                  display: flex;
                  width: 100%;
                ...
                <inscriptum-margin .pageId=${e.data.id} .marginId=${e.data.margins.length>0?e.data.margins[0].id:void 0} @changeMarginMode=${$}></inscriptum-margin>
              </div>`}
          </div>`}t=yield(0,n.sY)(l,this)}}finally{v.unsubscribe()}})),Xe=(0,i.EG)({props:{items:i.p.req()}})((function*(t){var e,i;for(;;)t=yield(0,n.sY)(n.dy`
        <style>${o(7713)}</style>
        <nav class="toc-panel">
