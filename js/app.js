...
var hyperHTML = function (globalDocument) {
    ...
    return function anyVirtual(value) {
      switch (typeof value === 'undefined' ? 'undefined' : _typeof(value)) {
        ...
        case 'boolean':
          ...
          } else if (childNodes.length === 1 && childNodes[0].nodeType === TEXT_NODE) {
            if (oldValue !== value) {
              oldValue = value;
        ...
        default:
          if (isArray(value)) {
            ...
            if (length === 0 && !justContent) {
              ...
              switch (_typeof(value[0])) {
                ...
                case 'function':
                  ...
                  var children = justContent ? slice.call(getChildren(node)) : childNodes;
            ...
            if (justContent) populateNode(node, value);else updateVirtualNodes(node, childNodes, value.nodeType === DOCUMENT_FRAGMENT_NODE ? slice.call(value.childNodes) : [value]);
            ...
            if (justContent) node.innerHTML = html;else {
              removeNodeList(childNodes, 0);
  ...
  function attributesSeeker(node, paths) {
    for (var attribute, value = UID, attributes = node.attributes, i = 0, length = attributes.length; i < length; i++) {
  ...
  function hyperSeeker(node, paths) {
    for (var child, childNodes = node.childNodes, length = childNodes.length, i = 0; i < length; i++) {
      child = childNodes[i];
      switch (child.nodeType) {
        case ELEMENT_NODE:
        ...
        case COMMENT_NODE:
          if (child.textContent === UID) {
            if (length === 1 || noContent(child, 'previous') && noContent(child, 'next')) {
          ...
          break;
        case TEXT_NODE:
          if (SHOULD_USE_ATTRIBUTE.test(node.nodeName) && trim.call(child.textContent) === UIDC) {
            paths.push(Path('any', node));
          }
          break;
      }
  ...
  function createFragment(node, html) {
    IEAttributes = [];
    return (OWNER_SVG_ELEMENT in node ? createSVGFragment : createHTMLFragment)(node, html.replace(no, comments));
  }
      ...
      switch (path[i++]) {
        ...
        case 'childNodes':
          ...
          if (childNodes.length) {
            insertBefore(parentNode, target, nextElementSibling(childNodes[childNodes.length - 1]));
          } else {
  ...
  function noContent(node, direction) {
    while ((node = node[direction + 'Sibling']) != null && node.nodeType === TEXT_NODE && trim.call(node.textContent).length < 1) {}
    return node == null;
  }
  ...
  var getChildren = WK || IE ? function (node) {
  ...
  var comments = function comments($0, $1, $2, $3) {
    return $1 + $2.replace(findAttributes, IE ? function ($0, $1, $2) {
...
var _this = this;
Object.defineProperty(exports, "__esModule", { value: true });
var polyfills_1 = __webpack_require__(130);
...
polyfills_1.default.then(function (p) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, Promise.resolve().then(function () { return __webpack_require__(338); }).then(function (c) {
                    customElements.whenDefined('um-app');
                })];
            case 1:
                _a.sent();
                return [4, Promise.resolve().then(function () { return __webpack_require__(341); }).then(function (c) {
                        customElements.whenDefined('um-articles-list');
                    })];
            case 2:
                _a.sent();
                return [4, Promise.resolve().then(function () { return __webpack_require__(344); }).then(function (c) {
                        customElements.whenDefined('um-article-preview');
                    })];
            case 3:
                _a.sent();
                return [4, Promise.resolve().then(function () { return __webpack_require__(350); }).then(function (c) {
                        customElements.whenDefined('um-article');
                    })];
            case 4:
                _a.sent();
                return [4, Promise.resolve().then(function () { return __webpack_require__(353); }).then(function (c) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 356))];
            case 1:
                _a.sent();
                return [3, 13];
            case 2:
                if (!window.customElements) return [3, 4];
                return [4, __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 357))];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4:
                if (!!('import' in document.createElement('link'))) return [3, 6];
                return [4, __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 358))];
            case 5:
                _a.sent();
                _a.label = 6;
            case 6:
                if (!(!window.customElements || window.customElements['forcePolyfill'])) return [3, 8];
                return [4, __webpack_require__.e/* import() */(7).then(__webpack_require__.bind(null, 359))];
            case 7:
                _a.sent();
                _a.label = 8;
            case 8:
                if (!(!('attachShadow' in Element.prototype && 'getRootNode' in Element.prototype)
                    || (window['ShadyDOM'] && window['ShadyDOM'].force))) return [3, 13];
                return [4, __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 360))];
            case 9:
                _a.sent();
                return [4, __webpack_require__.e/* import() */(4).then(__webpack_require__.bind(null, 361))];
            case 10:
                _a.sent();
                return [4, __webpack_require__.e/* import() */(6).then(__webpack_require__.bind(null, 362))];
            case 11:
                _a.sent();
                return [4, __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 363))];
            case 12:
                _a.sent();
                _a.label = 13;
            case 13: return [2];
...
Object.defineProperty(exports, "__esModule", { value: true });
var hyperHTML = __webpack_require__(64);
var AppComponent = (function (_super) {
    __extends(AppComponent, _super);
    function AppComponent(saying) {
        var _this = _super.call(this) || this;
        _this.saying = saying;
        _this._template = __webpack_require__(340);
        return _this;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var articles_list_component_1 = __webpack_require__(342);
...
Object.defineProperty(exports, "__esModule", { value: true });
var article_preview_component_1 = __webpack_require__(345);
...
var hyperHTML = __webpack_require__(64);
__webpack_require__(91);
var utils_1 = __webpack_require__(128);
...
var ArticlePreviewComponent = (function (_super) {
    ...
    function ArticlePreviewComponent(articleTitle, articleName, articleDate) {
        ...
        _this._template = __webpack_require__(348);
        _this._style = __webpack_require__(349);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Navigo = __webpack_require__(347);
...
(function webpackUniversalModuleDefinition(root, factory) {
	if (( false ? 'undefined' : _typeof2(exports)) === 'object' && ( false ? 'undefined' : _typeof2(module)) === 'object') module.exports = factory();else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof2(exports)) === 'object') exports["Navigo"] = factory();else root["Navigo"] = factory();
})(undefined, function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var article_component_1 = __webpack_require__(351);
...
var ArticleComponent = (function (_super) {
    ...
    function ArticleComponent(articleName, articleContent, articleTitle, articleDate) {
        ...
        _this.articleTitle = articleTitle;
        _this.articleDate = articleDate;
        _this._template = __webpack_require__(352);
        return _this;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var gist_component_1 = __webpack_require__(354);
...
var GistComponent = (function (_super) {
    ...
    function GistComponent(iframeid) {
        ...
        _this._template = __webpack_require__(355);
        _this.innerHTML = _this._template(_this);
        return _this;
    }
    GistComponent.prototype.connectedCallback = function () {
        var iframeEl = this.querySelector('iframe');
        var doc = iframeEl['contentDocument'] || iframeEl['contentWindow'];
        doc.open();
        ...
        doc.close();
        iframeEl['contentWindow'].onload = function () {
