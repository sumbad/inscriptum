"use strict";(self.webpackChunkinscriptum=self.webpackChunkinscriptum||[]).push([[94],{5094:(t,e,o)=>{o.r(e),o.d(e,{draftElement:()=>lo});var n=o(1640),i=o(7165),r=o(3619),a=o(9491),l=o(9725),s=o(4860),c=o(7012),d=o(667),p=o(669);const u=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
    ...
    `,this)})),Bt=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
        <svg xmlns="http://www.w3.org/2000/svg" 
...
`;for(;;){let n=null!==(e=t.isOn)&&void 0!==e&&e;t=yield(0,p.$)(n?o:i,this)}})),Zt=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
    ...
    `,this)}));var qt=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};window.requestIdleCallback=window.requestIdleCallback||function(t){setTimeout(t,1)};class Wt{constructor(t,e){this.canvas=t,this.canvasRect=this.canvas.getBoundingClientRect(),this.isMousedown=!1,this.points=[],this.strokeHistory=[],this._defaultOptions={backgroundColor:"rgba(0,0,0,0)"},this.lineWidth=0,this._penColor="black",this._penSize=1,this._mouseout=()=>{this.penEl.style.left="-100px",this.penEl.style.top="-100px"},this._startDraw=t=>{const e=this._prepareEvent(t);null!=e&&(t.preventDefault(),this.isMousedown=!0,this.lineWidth=8*Math.log(e.pressure*this._penSize+1),this.context.lineWidth=this.lineWidth,this.canvasRect=this.canvas.getBoundingClientRect(),this.points.push(this._createPoint(e.drawEvent,this.lineWidth)),this._draw(this.points))},this._continueDraw=t=>{const e=this._prepareEvent(t);if(null==e)return;let o=8*Math.log(e.pressure*this._penSize+1);o+=.5*this.lineWidth,this.lineWidth=o;const n=this._createPoint(e.drawEvent,o);this.penEl.style.left=n.x-this._penSize/2-1+"px",this.penEl.style.top=n.y-this._penSize/2-1+"px",this.isMousedown&&(this.points.push(n),this._draw(this.points))},this._stopDraw=()=>{this.isMousedown=!1,this.lineWidth=0,requestIdleCallback((()=>{this.points.length>0&&(this.strokeHistory.push([...this.points]),this.points=[])}))},this.context=t.getContext("2d"),this._options=Object.assign(Object.assign({},this._defaultOptions),e),this.context.fillStyle=this._options.backgroundColor,this.context.clearRect(0,0,this.canvas.width,this.canvas.height),this.context.fillRect(0,0,this.canvas.width,this.canvas.height);const o="ontouchstart"in document,n=/Macintosh/.test(navigator.userAgent)&&o;null==window.PointerEvent||n?(this._handleMouseEvents(),o&&this._handleTouchEvents()):this._handlePointerEvents(),this.canvas.addEventListener("mouseout",this._mouseout);const i=Math.floor(this._penSize);this.penEl=document.createElement("div"),this.penEl.style.width=`${i}px`,this.penEl.style.height=`${i}px`,this.penEl.style.border="1px solid gray",this.penEl.style.borderRadius="50%",this.penEl.style.position="absolute",this.penEl.style.pointerEvents="none",this.penEl.style.backgroundColor=this._penColor,this.penEl.style.left="-100px",this.penEl.style.top="-100px",t.after(this.penEl),this.setMode("pencil")}set penColor(t){this._penColor=t,null!=this.penEl&&(this.penEl.style.backgroundColor=this._penColor)}set penSize(t){if(this._penSize=t,null!=this.penEl){const t=Math.floor(this._penSize);this.penEl.style.width=`${t}px`,this.penEl.style.height=`${t}px`}}get isEmpty(){return 0===this.strokeHistory.length}restore(t=this.strokeHistory){for(const e of t){this.context.beginPath();let t=[];e.map((e=>{t.push(e),this._draw(t)}))}}setMode(t){switch(t){case"erase":this.context.globalCompositeOperation="destination-out",this.penEl.style.backgroundColor=this._defaultOptions.backgroundColor,this.canvas.style.cursor="none";break;case"pencil":this.context.globalCompositeOperation="source-over",this.penEl.style.backgroundColor=this._penColor,this.canvas.style.cursor="crosshair"}}clear(){this.dataUrlImage=null,this.context.fillStyle=this._options.backgroundColor,this.context.clearRect(0,0,this.canvas.width,this.canvas.height),this.context.fillRect(0,0,this.canvas.width,this.canvas.height)}reset(){this.lineWidth=0,this.isMousedown=!1,this.points=[],this.strokeHistory=[]}toDataURL(t="image/png",e){return this.canvas.toDataURL(t,e)}fromDataURL(t,e={}){return qt(this,void 0,void 0,(function*(){this._options=Object.assign(Object.assign({},this._options),{backgroundColor:this._defaultOptions.backgroundColor}),this.clear(),yield new Promise(((o,n)=>{const i=new Image,r=e.ratio||window.devicePixelRatio||1,a=e.width||this.canvas.width/r,l=e.height||this.canvas.height/r,s=e.xOffset||0,c=e.yOffset||0;i.onload=()=>{const t=this.context.globalCompositeOperation;this.context.globalCompositeOperation="source-over",this.context.drawImage(i,s,c,a,l),this.context.globalCompositeOperation=t,o()},i.onerror=t=>{n(t)},i.crossOrigin="anonymous",i.src=t})),this.dataUrlImage={dataUrl:t,options:e}}))}undoDraw(){return qt(this,void 0,void 0,(function*(){const t=this.context.globalCompositeOperation;this.strokeHistory.pop(),this.context.clearRect(0,0,this.canvas.width,this.canvas.height),null!=this.dataUrlImage&&(yield this.fromDataURL(this.dataUrlImage.dataUrl,this.dataUrlImage.options)),this.strokeHistory.map((t=>{this.context.beginPath();let e=[];t.map((t=>{e.push(t),this._draw(e)}))})),this.context.globalCompositeOperation=t}))}_draw(t){this.context.lineCap="round",this.context.lineJoin="round";const e=t.length-1,o=t[e-1],n=t[e];if(this.context.strokeStyle=n.color,this.context.globalCompositeOperation=n.globalCompositeOperation,t.length>=3){const t=(n.x+o.x)/2,e=(n.y+o.y)/2;this.context.lineWidth=o.lineWidth,this.context.quadraticCurveTo(o.x,o.y,t,e),this.context.stroke(),this.context.beginPath(),this.context.moveTo(t,e)}else this.context.lineWidth=n.lineWidth,this.context.beginPath(),this.context.moveTo(n.x,n.y),this.context.stroke()}_prepareEvent(t){let e,o=0,n="mouse";if("touches"in t){if(1!==t.touches.length)return null;{t.preventDefault();const i=t.touches[0];o=i.force,n=i.touchType,e=i}}else"pressure"in t&&(o=t.pressure/2.5,n=t.pointerType),e=t;if(["direct","mouse",void 0].includes(n)&&0===o&&(o=this._penSize/5),null==this.inputType||["pen","stylus"].includes(n))this.inputType=n,"stylus"===n&&"source-over"===this.context.globalCompositeOperation?this.penEl.style.display="none":this.penEl.style.display="block";else if(this.inputType!=n)return null;return{pressure:o,drawEvent:e,inputType:n}}_createPoint(t,e){return{x:t.clientX-this.canvasRect.left,y:t.clientY-this.canvasRect.top,lineWidth:e,color:this._penColor,globalCompositeOperation:this.context.globalCompositeOperation}}_handlePointerEvents(){this.canvas.addEventListener("pointerdown",this._startDraw),this.canvas.addEventListener("pointermove",this._continueDraw),document.addEventListener("pointerup",this._stopDraw)}_handleMouseEvents(){this.canvas.addEventListener("mousedown",this._startDraw),this.canvas.addEventListener("mousemove",this._continueDraw),document.addEventListener("mouseup",this._stopDraw)}_handleTouchEvents(){this.canvas.addEventListener("touchstart",this._startDraw),this.canvas.addEventListener("touchmove",this._continueDraw),this.canvas.addEventListener("touchend",this._stopDraw)}destroy(){this.canvas.removeEventListener("mouseout",this._mouseout),this.canvas.removeEventListener("pointerdown",this._startDraw),this.canvas.removeEventListener("pointermove",this._continueDraw),document.removeEventListener("pointerup",this._stopDraw),this.canvas.removeEventListener("mousedown",this._startDraw),this.canvas.removeEventListener("mousemove",this._continueDraw),document.removeEventListener("mouseup",this._stopDraw),this.canvas.removeEventListener("touchstart",this._startDraw),this.canvas.removeEventListener("touchmove",this._continueDraw),this.canvas.removeEventListener("touchend",this._stopDraw)}}const Jt=(0,i.NG)((function*(){for(;;)yield(0,p.$)(n.YP`
      ...
      `,this)}));var te=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};const ee=Gt(),oe=Yt(),ne=Ft(),ie=Ut(),re=Jt(),ae=Vt(),le=Kt(),se=Xt(),ce=Qt(),de=(0,i.EG)({props:{data:i.p.req(),mode:i.p.opt()}})((function*(t){var e,o,i,r;const s=(0,a.V)(),c=(0,a.V)();let p,u,h=t.data,g=t.mode,f=Math.max(window.devicePixelRatio||1,1),m=null!==(o=null===(e=h.options)||void 0===e?void 0:e.height)&&void 0!==o?o:0,v=null!==(r=null===(i=h.options)||void 0===i?void 0:i.width)&&void 0!==r?r:0,y=1,w=1.2,x="#000000";const _=()=>{const t=s.value,e=c.value;if(null==t||null==e)throw new Error("Can not find a canvas element!");if(p=e.getContext("2d"),null==p)throw new Error("Can not find a canvas context!");const o=v,n=m;m=Math.max(t.getBoundingClientRect().height,window.innerHeight,n),v=Math.max(t.getBoundingClientRect().width,o),e.height=m,e.width=v,e.style.height=`${m}px`,e.style.width=`${v}px`,t.style.height=`${m}px`,this.style.height=`${m}px`,f=Math.max(window.devicePixelRatio||1,1),e.width=e.offsetWidth*f,e.height=e.offsetHeight*f,p.scale(f,f),null==u&&(u=new Wt(e),u.penSize=w)},k=(t=!0)=>te(this,void 0,void 0,(function*(){if(null!=u){if(u.setMode("pencil"),null!=(null==h?void 0:h.imgBase64)&&null!=(null==h?void 0:h.options)){const t=h.options,e=`${t.type},${h.imgBase64}`;u.context.globalAlpha=y,yield u.fromDataURL(e,{height:t.height,width:t.width,ratio:f})}else u.clear();u.context.globalAlpha=1,t?u.restore():u.reset()}})),$=()=>{if(null==u||u.isEmpty)return alert("Please draw something.");null!=(null==h?void 0:h.id)&&function(t,e,o){jt(this,void 0,void 0,(function*(){const[n,i]=e.split(",");return yield(0,Mt.G)((()=>jt(this,void 0,void 0,(function*(){const{update_margin_by_pk:e}=yield(0,b.S)().saveMargin({id:t,options:Object.assign(Object.assign({},o),{type:n}),img:i,updated_at:(new Date).toISOString()});if(null!=e)return l.Z.dispatch({type:Tt.o.SAVE_DONE,payload:e}),l.Z.dispatch({type:Lt.C.SHOW,payload:{status:"success",type:"top-right",message:"Successfully saved"}}),e;l.Z.dispatch({type:Tt.o.SAVE_FAIL,payload:{id:t,error:{message:`The Margin ${t} has not been saved!`}}})}))))}))}(h.id,u.toDataURL(),{height:m,width:v,ratio:f})},M=()=>{null!=h.id&&It(h.id),null!=u&&u.clear(),null!=p&&(p.font="26px sans-serif",p.fillStyle="#CCCCCC",p.fillText("loading...",50,100))};function P(){null!=u&&u.setMode("erase")}const E=()=>{!function(t){jt(this,void 0,void 0,(function*(){l.Z.dispatch({type:Tt.o.LOAD_DONE,payload:{id:t.id,pageId:t.pageId}})}))}(h)};function C(t){if(null!=(null==t?void 0:t.currentTarget)&&null!=u){const e=t.currentTarget;y=Number(e.value)}}function z(){null!=u&&u.undoDraw()}const A=t=>{null!=u&&(u.penColor=t.detail.value,u.setMode("pencil"),this.next())},S=t=>{if(null!=u&&null!=(null==t?void 0:t.currentTarget)){const e=t.currentTarget;w=Number(e.value),u.penSize=w}},L=()=>{null!=u&&u.setMode("pencil")};window.onresize=()=>{_(),k()},requestAnimationFrame((()=>{_(),k()}));try{for(;;)Object.is(h,t.data)||(h=t.data,k(!1)),g!==t.mode&&("full"!=t.mode&&"full"!=g&&(_(),k()),g=t.mode),t=yield(0,n.sY)(n.dy`
          ...
          <div class="fab-container fab-container_main">
            <div class="fab-container fab-container_vertical">
              <hex-color-picker id=${`${h.id}_colorPicker`} name="colorPicker" style=${d.iv`
                  cursor: pointer;
                `} .value=${x} @color-changed=${A}></hex-color-picker>
            </div>
            ...
            <div class="fab-container fab-container_vertical">
              <button class="fab-button fab-button_empty" style=${d.iv`
                ...
                <div class="sub-button">
                  <input type="range" .value=${w} min="0.5" max="10" step="0.5" @input=${S}>
                </div>
              </button>
            ...
            <div class="fab-container fab-container_vertical">
              <button class="fab-button fab-button_empty" @click=${k}>
                <div class="sub-button">
                  <input type="range" .value=${y} min="0" max="1" step="0.01" @input=${C}>
      ...
      `,this)}));var he=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};de("sketch-pad");const ge=Dt(),fe=Bt(),be=Nt(),me=Zt(),ve=Rt(),ye=ue(),we=(0,i.EG)({props:{pageId:i.p.req(),marginId:i.p.opt(),onchangeMarginMode:i.p.opt()}})((function*(t){var e;const i=this.attachShadow({mode:"open"}),r=[];let a,c=Ot,p=null!=t.marginId?"hide":"empty";const u=l.Z.$.pipe((0,pe.Z)(Tt.o),(0,f.h)((e=>e.type!==Tt.o.CREATE_FAIL&&e.payload.id===t.marginId))),h=t=>()=>he(this,void 0,void 0,(function*(){const e=i.host;switch(t){case"expand":e.style.position="absolute",e.style.borderLeft="none";break;case"full":e.style.borderLeft="none",yield function(t){return he(this,void 0,void 0,(function*(){"requestFullscreen"in t&&null==document.fullscreenElement?yield t.requestFullscreen():"webkitRequestFullscreen"in t&&(yield t.webkitRequestFullscreen())}))}(e);break;case"collapse":e.style.position="relative",e.style.borderLeft="solid 1px var(--light-grey)",yield xe();break;default:e.style.borderLeft="none",e.style.position="relative",yield xe()}p=t,this.dispatchEvent(new CustomEvent("changeMarginMode",{detail:{mode:p}})),this.next()})),g=()=>{var e;null==(null===(e=null==c?void 0:c.data)||void 0===e?void 0:e.id)&&function(t){jt(this,void 0,void 0,(function*(){return yield(0,Mt.G)((()=>jt(this,void 0,void 0,(function*(){const{insert_margin_one:e}=yield(0,b.S)().createMargin({page_id:t,created_at:(new Date).toISOString()});if(null!=(null==e?void 0:e.id))return l.Z.dispatch({type:Tt.o.CREATE_DONE,payload:{id:e.id,pageId:t}}),e;l.Z.dispatch({type:Tt.o.CREATE_FAIL,payload:{pageId:t,error:{massage:`Can not create a new Margin for Page ${t}!`}}})}))))}))}(t.pageId)};r.push(l.Z.$.pipe((0,f.h)((t=>t.type===s.u.FULLSCREEN_CHANGED))).subscribe((t=>{t.type===s.u.FULLSCREEN_CHANGED&&(t.payload.isFullscreen&&"full"!==p&&(p="full",this.next()),t.payload.isFullscreen||"full"!==p||(p="collapse",this.next()))})));try{for(;;){null!=t.marginId&&t.marginId!==(null===(e=c.data)||void 0===e?void 0:e.id)&&(null==a||a.unsubscribe(),a=u.subscribe((t=>{c=Ht(c,t),this.next()})),"empty"===p&&h("collapse")(),It(t.marginId));let r=n.dy``;switch(p){case"empty":r=n.dy`<button class="btn btn_icon btn__first" title="create new margin" @click=${g}>
              ${ye({})}
        ...
        `,i)}}finally{r.forEach((t=>t.unsubscribe())),null==a||a.unsubscribe()}}));function xe(){return he(this,void 0,void 0,(function*(){"exitFullscreen"in document&&null!=document.fullscreenElement?yield document.exitFullscreen():"webkitExitFullscreen"in document&&(yield document.webkitExitFullscreen())}))}const _e=String.raw,ke=(0,St.EG)({props:{label:String,value:String,isFolded:Boolean,change:{}},shadow:{mode:"open"},render:At.sY})((function(t){const[e,o]=(0,St.eJ)(t.isFolded);(0,St.d4)((()=>{o(t.isFolded)}),[t.isFolded]);const n=(0,St.I4)((()=>{o((t=>!t)),t.change(t.value,!e)}),[e,o,t]);return(0,St.d4)((()=>{const t=_e`
      :host {
        display: inline-flex;
        align-items: center;
        flex-direction: row;
    ...
    `,e=null==this?void 0:this.shadowRoot;if(null!=e&&null!=e.adoptedStyleSheets){const o=new CSSStyleSheet;o.replaceSync(t),e.adoptedStyleSheets=[o]}}),[]),At.dy`
    ...
    `})),$e=(0,At.XM)(((t,e)=>(null!=e.current&&(e.current.setValue(t),e.current.commit()),o=>{e.current=o,e.current.setValue(t)}))),Me=(0,St.NG)({render:$e})((()=>At.YP`
  ...
  `));var Ee=o(9917),Ce=o(1545),ze=o(2006),Ae=o(2965),Se=o(4978),Le=o(2237),Te=o(9878),je=o(8225),Ie=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};function Oe(t){return t.pipe((0,ze.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVE,payload:{pageId:t.pageId,draftId:t.draftId}})})),(0,Ae.b)(kt.v.isDevMode?3e3:1e4),(0,ze.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVING,payload:{pageId:t.pageId,draftId:t.draftId}})})),(0,Se.w)((t=>(0,Ee.P)((()=>function(t,e,o){return Ie(this,void 0,void 0,(function*(){return yield(0,Mt.G)((()=>Ie(this,void 0,void 0,(function*(){return yield(0,b.S)().updatePageById({id:t,content:o,updated_at:(new Date).toISOString()}),{pageId:t,draftId:e,content:o}}))))}))}(t.pageId,t.draftId,t.content))).pipe((0,ze.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVE_DONE,payload:t})})),(0,Le.a)((0,je.W)()),(0,Te.K)((e=>(l.Z.dispatch({type:s.u.PAGE_SAVE_FAIL,payload:{draftId:t.draftId,pageId:t.pageId,error:e}}),Ce.E)))))))}function He(t){return t.pipe((0,Se.w)((t=>(0,Ee.P)((()=>Ie(this,void 0,void 0,(function*(){return(0,Mt.G)((()=>Ie(this,void 0,void 0,(function*(){var e;const{insert_page_one:o,update_page:n}=yield(0,b.S)().addPageToDraft({draft_id:t.draftId,order:t.order,created_at:(new Date).toISOString()});if(null==o)throw new Error("newPage == null");const i=null!==(e=null==n?void 0:n.returning)&&void 0!==e?e:[];return{draftId:t.draftId,newPage:o,updatedPages:i}}))))})))))),(0,ze.b)((t=>{const{draftId:e,updatedPages:o,newPage:n}=t;l.Z.dispatch({type:s.u.DRAFT_ADD_PAGE_DONE,payload:{draftId:e,newPage:Object.assign(Object.assign({},n),{content:null==n?void 0:n.content,draftId:e}),updatedPages:o}})})))}function De(t){return t.pipe((0,Se.w)((t=>(0,Ee.P)((()=>Ie(this,void 0,void 0,(function*(){return(0,Mt.G)((()=>Ie(this,void 0,void 0,(function*(){var e;const{update_page_by_pk:o,update_page:n}=yield(0,b.S)().deletePage({id:t.pageId,ended_at:(new Date).toISOString(),draft_id:t.draftId,order:t.order}),i=null!==(e=null==n?void 0:n.returning)&&void 0!==e?e:[],r={id:null==o?void 0:o.id,order:t.order};return{draftId:t.draftId,deletedPage:r,updatedPages:i}}))))})))))),(0,ze.b)((t=>{l.Z.dispatch({type:s.u.DRAFT_DELETE_PAGE_DONE,payload:{draftId:t.draftId,deletedPage:t.deletedPage,updatedPages:t.updatedPages}})})))}function Be(t,e){return e.type===Tt.o.CREATE_DONE?(null!=t.data&&(t.data.margins=[{id:e.payload.id},...t.data.margins]),t):t}var Ne=o(6716);function Ze(t){const[e,o]=(0,St.eJ)();return(0,St.d4)((()=>{const e=new Ne.x;return o([t(e),t=>e.next(t)]),()=>e.unsubscribe()}),[]),e}function Re(){const[t]=(0,St.eJ)((()=>{let t;return{get current(){var e;return null===(e=null==t?void 0:t.committer)||void 0===e?void 0:e.element},ref:(0,At.XM)((()=>e=>{t=e}))}}));return t}var Ge=o(7072);const Fe=(0,St.EG)({props:{editor:{},className:String,tippyOptions:{},pluginKey:{type:String,default:Ge.NM.options.pluginKey},shouldShow:{type:{},default:null}},render:At.sY})((function(t){const[e,o]=(0,St.eJ)(0),n=Re(),[i,r]=(0,St.eJ)(null);return(0,St.d4)((()=>{console.log("useEffect bubbleMenuElement"),cancelAnimationFrame(e);const{editor:i,tippyOptions:a}=t;o(requestAnimationFrame((()=>{null!=n.current&&i.registerPlugin((0,Ge.q3)({editor:i,element:n.current,pluginKey:t.pluginKey,shouldShow:t.shouldShow}))})));const l=new Ne.x,s=({transaction:t})=>{t.steps.length>0?r(qe(i)):t.selection.empty?r(null):l.next()};return i.on("transaction",s),l.pipe((0,Ae.b)(700)).subscribe((()=>{r(qe(i))})),()=>{console.log("DESTROY bubbleMenuElement"),l.unsubscribe(),i.off("transaction",s),cancelAnimationFrame(e),i.unregisterPlugin(Ge.NM.options.pluginKey)}}),[n.current]),At.dy`<div .ref=${n.ref()} class=${t.className} style=${d.iv`
        visibility: 'hidden';
      `}>
      ${i}
    </div>`})),Ye=["figure"],Ue=["topicTitle"];function qe(t){const e=t.state.selection;return e instanceof F.qv&&Ye.includes(e.node.type.name)||e instanceof F.Bs&&(Ue.includes(e.$from.parent.type.name)||Ue.includes(e.$to.parent.type.name))?null:[B.ZP.name,N.Z.name,R.Z.name,Z.Z.name].includes(e.$from.parent.type.name)?At.dy`
    ...
    `}var We=o(5394);const Je=(0,i.EG)({props:{editor:i.p.req()}})((function*(t){for(requestAnimationFrame((()=>{t.editor.registerPlugin((0,We.JF)({editor:t.editor,element:this.firstElementChild,pluginKey:We.AH.options.pluginKey,shouldShow:({state:t})=>{const{selection:e}=t,{$anchor:o,empty:n}=e,i=1===o.depth,r=o.parent.isTextblock&&!o.parent.type.spec.code&&!o.parent.textContent;return!!(n&&i&&r)},tippyOptions:{interactive:!0,placement:"left",arrow:!1,zIndex:0}})),this.style.zIndex="0"}));;)yield(0,n.sY)(n.dy`<div>
      ...
      ${null!=i&&At.dy`
        ...
        `}
    </div>`}))),Ke=String.raw,Xe=(Ve("inscriptum-redactor"),we("inscriptum-margin"),ke("inscriptum-folding"),Me()),Qe=Pe(),to=(0,St.EG)({props:{page:{type:{}},header:{type:{}}},render:At.sY})((function(t){const[e,n]=(0,St._Y)(Be,{data:t.page,isLoading:!1});let[i,r]=(0,St.eJ)(t.page.content);const[a,s]=(0,St.eJ)(t.page.isFolded),[c,d]=(0,St.eJ)("hide"),[p,u]=Ze(Oe),[h,g]=Ze(He),[b,m]=Ze(De);(0,St.d4)((()=>{const o=(i=t.page.id,l.Z.$.pipe((0,pe.Z)(Tt.o),(0,f.h)((t=>t.type===Tt.o.CREATE_DONE&&t.payload.pageId===i)))).subscribe((t=>n(t)));var i;return o.add(p.subscribe((t=>{null!=e.data&&(e.data.content=t.content)}))),o.add(h.subscribe()),o.add(b.subscribe()),()=>{o.unsubscribe()}}),[]),(0,St.d4)((()=>{var t;null!=(null===(t=null==e?void 0:e.data)||void 0===t?void 0:t.content)&&(null==i&&null!=e.data.content&&r(e.data.content),null!=e.data.isFolded&&a!==e.data.isFolded&&(e.data.isFolded||r(e.data.content)))}),[e,i,a,r,s]);const v=(0,St.I4)((t=>{null!=e.data&&(u({pageId:e.data.id,draftId:e.data.draftId,content:t}),null!=i?i.content=t.content:i=t)}),[e,u,i]),y=(0,St.I4)((t=>()=>{var o;null!=(null===(o=e.data)||void 0===o?void 0:o.draftId)&&g({draftId:e.data.draftId,order:t})}),[e.data,u]),w=(0,St.I4)((()=>{null!=e.data&&m({draftId:e.data.draftId,pageId:e.data.id,order:e.data.order})}),[e.data]),x=(0,St.I4)((t=>{d(t.detail.mode)}),[e]);if(null!=(null==e?void 0:e.data)){const n=At.dy`<div class="page__controls">
        <div>
          <button class="btn btn_icon" title="add a new page" @click=${y(e.data.order+1)}>
            ${Xe({})}
          </button>
          ${e.data.order>0?At.dy`<button class="btn btn_icon" title="delete this page" @click=${w}>
              ${Qe({})}
            </button>`:null}
        </div>
      </div>`;return At.dy`
      ...
      `}})),eo=(0,i.EG)({props:{items:i.p.req()}})((function*(t){var e,n;for(;;)t=yield(0,At.sY)(At.dy`
        <style>${o(7135)}</style>
        <nav class="toc-panel">
