            ...
            <div class="fab-container fab-container_main">
              ...
              <div class="fab-container fab-container_vertical">
                <hex-color-picker class="fab-button_static" id=${`${h.id}_colorPicker`} name="colorPicker" style=${d.iv`
                    cursor: pointer;
                  `} .value=${x} @color-changed=${T}></hex-color-picker>
              </div>
...
`,Me=(0,i.EG)({props:{label:i.p.req(),value:i.p.req(),isFolded:i.p.req(),change:i.p.req()}})((function*(t){const e=this.attachShadow({mode:"open"});let o=t;(0,d.A_)($e,e);const i=()=>{t.change(t.value,!o.isFolded)};for(;;)Object.is(t,o)||(o=t),t=yield(0,n.sY)(n.dy`
      ...
      `,e)})),Pe=(0,jt.XM)(((t,e)=>(null!=e.current&&(e.current.setValue(t),e.current.commit()),o=>{e.current=o,e.current.setValue(t)}))),Ee=(0,Lt.NG)({render:Pe})((()=>jt.YP`
  ...
  `));var Ae=o(9917),ze=o(1545),Te=o(2006),je=o(2965),Le=o(4978),Se=o(2237),Oe=o(9878),Ie=o(8225),He=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};function De(t){return t.pipe((0,Te.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVE,payload:{pageId:t.pageId,draftId:t.draftId}})})),(0,je.b)(Mt.v.isDevMode?3e3:1e4),(0,Te.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVING,payload:{pageId:t.pageId,draftId:t.draftId}})})),(0,Le.w)((t=>(0,Ae.P)((()=>function(t,e,o){return He(this,void 0,void 0,(function*(){return yield(0,Et.G)((()=>He(this,void 0,void 0,(function*(){return yield(0,b.S)().updatePageById({id:t,content:o,updated_at:(new Date).toISOString()}),{pageId:t,draftId:e,content:o}}))))}))}(t.pageId,t.draftId,t.content))).pipe((0,Te.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVE_DONE,payload:t})})),(0,Se.a)((0,Ie.W)()),(0,Oe.K)((e=>(l.Z.dispatch({type:s.u.PAGE_SAVE_FAIL,payload:{draftId:t.draftId,pageId:t.pageId,error:e}}),ze.E)))))))}function Ne(t){return t.pipe((0,Le.w)((t=>(0,Ae.P)((()=>He(this,void 0,void 0,(function*(){return(0,Et.G)((()=>He(this,void 0,void 0,(function*(){var e;const{insert_page_one:o,update_page:n}=yield(0,b.S)().addPageToDraft({draft_id:t.draftId,order:t.order,created_at:(new Date).toISOString()});if(null==o)throw new Error("newPage == null");const i=null!==(e=null==n?void 0:n.returning)&&void 0!==e?e:[];return{draftId:t.draftId,newPage:o,updatedPages:i}}))))})))))),(0,Te.b)((t=>{const{draftId:e,updatedPages:o,newPage:n}=t;l.Z.dispatch({type:s.u.DRAFT_ADD_PAGE_DONE,payload:{draftId:e,newPage:Object.assign(Object.assign({},n),{content:null==n?void 0:n.content,draftId:e}),updatedPages:o}})})))}function Be(t){return t.pipe((0,Le.w)((t=>(0,Ae.P)((()=>He(this,void 0,void 0,(function*(){return(0,Et.G)((()=>He(this,void 0,void 0,(function*(){var e;const{update_page_by_pk:o,update_page:n}=yield(0,b.S)().deletePage({id:t.pageId,ended_at:(new Date).toISOString(),draft_id:t.draftId,order:t.order}),i=null!==(e=null==n?void 0:n.returning)&&void 0!==e?e:[],r={id:null==o?void 0:o.id,order:t.order};return{draftId:t.draftId,deletedPage:r,updatedPages:i}}))))})))))),(0,Te.b)((t=>{l.Z.dispatch({type:s.u.DRAFT_DELETE_PAGE_DONE,payload:{draftId:t.draftId,deletedPage:t.deletedPage,updatedPages:t.updatedPages}})})))}function Ze(t,e){return e.type===Ot.o.CREATE_DONE?(null!=t.data&&(t.data.margins=[{id:e.payload.id},...t.data.margins]),t):t}var Re=o(6716);function Ge(t){const[e,o]=(0,Lt.eJ)();return(0,Lt.d4)((()=>{const e=new Re.x;return o([t(e),t=>e.next(t)]),()=>e.unsubscribe()}),[]),e}function Fe(){const[t]=(0,Lt.eJ)((()=>{let t;return{get current(){var e;return null===(e=null==t?void 0:t.committer)||void 0===e?void 0:e.element},ref:(0,jt.XM)((()=>e=>{t=e}))}}));return t}var qe=o(7072);const Ye=(0,Lt.EG)({props:{editor:{},className:String,tippyOptions:{},pluginKey:{type:String,default:qe.NM.options.pluginKey},shouldShow:{type:{},default:null}},render:jt.sY})((function(t){const[e,o]=(0,Lt.eJ)(0),n=Fe(),[i,r]=(0,Lt.eJ)(null);return(0,Lt.d4)((()=>{console.log("useEffect bubbleMenuElement"),cancelAnimationFrame(e);const{editor:i,tippyOptions:a}=t;o(requestAnimationFrame((()=>{null!=n.current&&i.registerPlugin((0,qe.q3)({editor:i,element:n.current,pluginKey:t.pluginKey,shouldShow:t.shouldShow}))})));const l=new Re.x,s=({transaction:t})=>{t.steps.length>0?r(We(i)):t.selection.empty?r(null):l.next()};return i.on("transaction",s),l.pipe((0,je.b)(700)).subscribe((()=>{r(We(i))})),()=>{console.log("DESTROY bubbleMenuElement"),l.unsubscribe(),i.off("transaction",s),cancelAnimationFrame(e),i.unregisterPlugin(qe.NM.options.pluginKey)}}),[n.current]),jt.dy`<div .ref=${n.ref()} class=${t.className} style=${d.iv`
        visibility: 'hidden';
      `}>
      ${i}
    </div>`})),Ue=["topicTitle"];function We(t){const e=t.state.selection;return e instanceof Y.qv&&"figure"===e.node.type.name?jt.dy`
        ...
        `:e instanceof Y.Bs&&(Ue.includes(e.$from.parent.type.name)||Ue.includes(e.$to.parent.type.name))?null:[Z.ZP.name,R.Z.name,F.Z.name,G.Z.name].includes(e.$from.parent.type.name)?jt.dy`
    ...
    `}var Ve=o(5394);const Je=(0,i.EG)({props:{editor:i.p.req()}})((function*(t){for(requestAnimationFrame((()=>{t.editor.registerPlugin((0,Ve.JF)({editor:t.editor,element:this.firstElementChild,pluginKey:Ve.AH.options.pluginKey,shouldShow:({state:t})=>{const{selection:e}=t,{$anchor:o,empty:n}=e,i=1===o.depth,r=o.parent.isTextblock&&!o.parent.type.spec.code&&!o.parent.textContent;return!!(n&&i&&r)},tippyOptions:{interactive:!0,placement:"left",arrow:!1,zIndex:0}})),this.style.zIndex="0"}));;)yield(0,n.sY)(n.dy`<div>
      ...
      </div>`,this)})),Ke=(Ye("inscriptum-redactor-bubble-menu"),Je("inscriptum-redactor-floating-menu"),(0,Lt.EG)({props:{content:{type:{},default:null},cbOnUpdateContent:{type:{},default:()=>{}},isTitle:Boolean,disable:Boolean},render:jt.sY})((function(t){const[e,n]=(0,Lt.eJ)(0),[i,r]=(0,Lt.eJ)(),a=Fe();return(0,Lt.d4)((()=>(cancelAnimationFrame(e),n(requestAnimationFrame((()=>{const e=a.current;if(null!=e){const o=t.content;r(function(t,e,o=!1,n){return new v.ML({element:t,content:e,onUpdate:null==n?void 0:n.onUpdate,extensions:$t(o)})}(e,o,t.isTitle,{onUpdate:({editor:e})=>{t.cbOnUpdateContent(e.getJSON())}}))}}))),()=>{var t,o;console.log("DESTROY redactorElement"),null===(o=null===(t=a.current)||void 0===t?void 0:t.firstChild)||void 0===o||o.remove(),cancelAnimationFrame(e),null!=i&&i.destroy()})),[a.current,t.content,t.isTitle,t.cbOnUpdateContent]),null!=i&&i.setEditable(!t.disable),jt.dy`<div class="redactor">
      <style>${o(5257)}</style>
      ...
      ${null!=i&&jt.dy`
        ...
        `}
    </div>`}))("inscriptum-redactor"),_e("inscriptum-margin"),Me("inscriptum-folding"),Ee()),Xe=Ce(),Qe=(0,Lt.EG)({props:{page:{type:{}},header:{type:{}}},render:jt.sY})((function(t){const[e,n]=(0,Lt._Y)(Ze,{data:t.page,isLoading:!1});let[i,r]=(0,Lt.eJ)(t.page.content);const[a,s]=(0,Lt.eJ)(t.page.isFolded),[c,p]=(0,Lt.eJ)("hide"),[u,h]=Ge(De),[g,b]=Ge(Ne),[m,v]=Ge(Be);(0,Lt.d4)((()=>{const o=(i=t.page.id,l.Z.$.pipe((0,he.Z)(Ot.o),(0,f.h)((t=>t.type===Ot.o.CREATE_DONE&&t.payload.pageId===i)))).subscribe((t=>n(t)));var i;return o.add(u.subscribe((t=>{null!=e.data&&(e.data.content=t.content)}))),o.add(g.subscribe()),o.add(m.subscribe()),()=>{o.unsubscribe()}}),[]),(0,Lt.d4)((()=>{var t;null!=(null===(t=null==e?void 0:e.data)||void 0===t?void 0:t.content)&&(null==i&&null!=e.data.content&&r(e.data.content),null!=e.data.isFolded&&a!==e.data.isFolded&&(e.data.isFolded||r(e.data.content)))}),[e,i,a,r,s]);const y=(0,Lt.I4)((t=>{null!=e.data&&(h({pageId:e.data.id,draftId:e.data.draftId,content:t}),null!=i?i.content=t.content:i=t)}),[e,h,i]),w=(0,Lt.I4)((t=>()=>{var o;null!=(null===(o=e.data)||void 0===o?void 0:o.draftId)&&b({draftId:e.data.draftId,order:t})}),[e.data,h]),x=(0,Lt.I4)((()=>{null!=e.data&&v({draftId:e.data.draftId,pageId:e.data.id,order:e.data.order})}),[e.data]),_=(0,Lt.I4)((t=>{p(t.detail.mode)}),[e]);if(null!=(null==e?void 0:e.data)){const n=jt.dy`<div class="page__controls">
        <div>
          <button class="btn btn_icon" title="add a new page" @click=${w(e.data.order+1)}>
            ${Ke({})}
          </button>
          ${e.data.order>0?jt.dy`<button class="btn btn_icon" title="delete this page" @click=${x}>
              ${Xe({})}
            </button>`:null}
        </div>
      </div>`;return jt.dy`
        ...
        ${a?jt.dy`
            ...
            ${n}
          `:jt.dy`<div class="row" style=${d.iv`
              display: flex;
              width: 100%;
      ...
      `}})),to=(0,i.EG)({props:{items:i.p.req()}})((function*(t){var e,n;for(;;)t=yield(0,jt.sY)(jt.dy`
        <style>${o(7135)}</style>
        <nav class="toc-panel">
          <ul class="toc-panel__list">
            ...
            ${t.items.slice(1).map(((t,e)=>{var o;return jt.dy`<li class="toc-panel__item">
