...
`,Me=(0,i.EG)({props:{label:i.p.req(),value:i.p.req(),isFolded:i.p.req(),change:i.p.req()}})((function*(t){const e=this.attachShadow({mode:"open"});let o=t;(0,d.A_)($e,e);const i=()=>{t.change(t.value,!o.isFolded)};for(;;)Object.is(t,o)||(o=t),t=yield(0,n.sY)(n.dy`
  ...
  `));var Ae=o(9917),ze=o(1545),Le=o(2006),Te=o(2965),je=o(4978),Se=o(2237),Oe=o(9878),Ie=o(8225),He=function(t,e,o,n){return new(o||(o=Promise))((function(i,r){function a(t){try{s(n.next(t))}catch(t){r(t)}}function l(t){try{s(n.throw(t))}catch(t){r(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o((function(t){t(e)}))).then(a,l)}s((n=n.apply(t,e||[])).next())}))};function De(t){return t.pipe((0,Le.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVE,payload:{pageId:t.pageId,draftId:t.draftId}})})),(0,Te.b)(Mt.v.isDevMode?3e3:1e4),(0,Le.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVING,payload:{pageId:t.pageId,draftId:t.draftId}})})),(0,je.w)((t=>(0,Ae.P)((()=>function(t,e,o){return He(this,void 0,void 0,(function*(){return yield(0,Et.G)((()=>He(this,void 0,void 0,(function*(){return yield(0,b.S)().updatePageById({id:t,content:o,updated_at:(new Date).toISOString()}),{pageId:t,draftId:e,content:o}}))))}))}(t.pageId,t.draftId,t.content))).pipe((0,Le.b)((t=>{l.Z.dispatch({type:s.u.PAGE_SAVE_DONE,payload:t})})),(0,Se.a)((0,Ie.W)()),(0,Oe.K)((e=>(l.Z.dispatch({type:s.u.PAGE_SAVE_FAIL,payload:{draftId:t.draftId,pageId:t.pageId,error:e}}),ze.E)))))))}function Ne(t){return t.pipe((0,je.w)((t=>(0,Ae.P)((()=>He(this,void 0,void 0,(function*(){return(0,Et.G)((()=>He(this,void 0,void 0,(function*(){var e;const{insert_page_one:o,update_page:n}=yield(0,b.S)().addPageToDraft({draft_id:t.draftId,order:t.order,created_at:(new Date).toISOString()});if(null==o)throw new Error("newPage == null");const i=null!==(e=null==n?void 0:n.returning)&&void 0!==e?e:[];return{draftId:t.draftId,newPage:o,updatedPages:i}}))))})))))),(0,Le.b)((t=>{const{draftId:e,updatedPages:o,newPage:n}=t;l.Z.dispatch({type:s.u.DRAFT_ADD_PAGE_DONE,payload:{draftId:e,newPage:Object.assign(Object.assign({},n),{content:null==n?void 0:n.content,draftId:e}),updatedPages:o}})})))}function Be(t){return t.pipe((0,je.w)((t=>(0,Ae.P)((()=>He(this,void 0,void 0,(function*(){return(0,Et.G)((()=>He(this,void 0,void 0,(function*(){var e;const{update_page_by_pk:o,update_page:n}=yield(0,b.S)().deletePage({id:t.pageId,ended_at:(new Date).toISOString(),draft_id:t.draftId,order:t.order}),i=null!==(e=null==n?void 0:n.returning)&&void 0!==e?e:[],r={id:null==o?void 0:o.id,order:t.order};return{draftId:t.draftId,deletedPage:r,updatedPages:i}}))))})))))),(0,Le.b)((t=>{l.Z.dispatch({type:s.u.DRAFT_DELETE_PAGE_DONE,payload:{draftId:t.draftId,deletedPage:t.deletedPage,updatedPages:t.updatedPages}})})))}function Ze(t,e){return e.type===Ot.o.CREATE_DONE?(null!=t.data&&(t.data.margins=[{id:e.payload.id},...t.data.margins]),t):t}var Re=o(6716);function Ge(t){const[e,o]=(0,jt.eJ)();return(0,jt.d4)((()=>{const e=new Re.x;return o([t(e),t=>e.next(t)]),()=>e.unsubscribe()}),[]),e}function Fe(){const[t]=(0,jt.eJ)((()=>{let t;return{get current(){var e;return null===(e=null==t?void 0:t.committer)||void 0===e?void 0:e.element},ref:(0,Tt.XM)((()=>e=>{t=e}))}}));return t}var qe=o(7072);const Ye=(0,jt.EG)({props:{editor:{},className:String,tippyOptions:{},pluginKey:{type:String,default:qe.NM.options.pluginKey},shouldShow:{type:{},default:null}},render:Tt.sY})((function(t){const[e,o]=(0,jt.eJ)(0),n=Fe(),[i,r]=(0,jt.eJ)(null);return(0,jt.d4)((()=>{console.log("useEffect bubbleMenuElement"),cancelAnimationFrame(e);const{editor:i,tippyOptions:a}=t;o(requestAnimationFrame((()=>{null!=n.current&&i.registerPlugin((0,qe.q3)({editor:i,element:n.current,pluginKey:t.pluginKey,shouldShow:t.shouldShow}))})));const l=new Re.x,s=({transaction:t})=>{t.steps.length>0?r(We(i)):t.selection.empty?r(null):l.next()};return i.on("transaction",s),l.pipe((0,Te.b)(700)).subscribe((()=>{r(We(i))})),()=>{console.log("DESTROY bubbleMenuElement"),l.unsubscribe(),i.off("transaction",s),cancelAnimationFrame(e),i.unregisterPlugin(qe.NM.options.pluginKey)}}),[n.current]),Tt.dy`<div .ref=${n.ref()} class=${t.className} style=${d.iv`
    ...
    `}var Ve=o(5394);const Je=(0,i.EG)({props:{editor:i.p.req()}})((function*(t){for(requestAnimationFrame((()=>{t.editor.registerPlugin((0,Ve.JF)({editor:t.editor,element:this.firstElementChild,pluginKey:Ve.AH.options.pluginKey,shouldShow:({state:t})=>{const{selection:e}=t,{$anchor:o,empty:n}=e,i=1===o.depth,r=o.parent.isTextblock&&!o.parent.type.spec.code&&!o.parent.textContent;return!!(n&&i&&r)},tippyOptions:{interactive:!0,placement:"left",arrow:!1,zIndex:0}})),this.style.zIndex="0"}));;)yield(0,n.sY)(n.dy`<div>
      ...
      `}})),to=(0,i.EG)({props:{items:i.p.req()}})((function*(t){var e,n;for(;;)t=yield(0,Tt.sY)(Tt.dy`
        <style>${o(7135)}</style>
        <nav class="toc-panel">
