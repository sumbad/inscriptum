(window.webpackJsonp=window.webpackJsonp||[]).push([[70,28,59,60,62],{117:function(e,t,i){"use strict";i.r(t),i.d(t,"postRouter",(function(){return a}));var s=i(22),n=i(51);class o extends n.AbstractRoute{constructor(){super(...arguments),this.$routePost=new s.a,this.$routePostsList=new s.a}getRouter(){return{rootPath:"/articles",routers:[{path:"/:id",callback:(e,t)=>this.$routePost.next({ctx:e,next:t})},{path:"",callback:(e,t)=>this.$routePostsList.next({ctx:e,next:t})},{path:"*",callback:(e,t)=>{e.handled?(e.handled=!1,t()):this.page.replace("/articles")}}]}}}const a=new o},118:function(e,t,i){"use strict";i.r(t),t.default=(e,t)=>e`
