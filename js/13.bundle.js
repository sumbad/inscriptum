...
`,this.$={isPreloader:!0},this._authService=new a.a(this._storageService)}connectedCallback(){var e,t;super.connectedCallback(),this._authService.$authenticated.pipe((e=()=>void 0===this.$.drafts,void 0===t&&(t=!1),function(i){return i.lift(new h(e,t))})).subscribe(e=>{e?this._storageService.api.draft.getAll().then(e=>{const t=e.map(e=>{const{content:t,title:i,image:o}=Object(g.b)(e.pages[0].content);return{id:e.id,preview:{title:i,description:t,image:o},linkUrl:"/editor/"+e.id,actions:[{label:"удалить",type:m.delete}]}});this.$={isPreloader:!1,drafts:t}}):null!==e&&this._authService.login()}),f.a.watch()}render(){return r.e`
    ...
    `}handleBtnCreateNewDraft(){return x(this,void 0,void 0,(function*(){const e=yield this._storageService.api.draft.create(this._storageService.author.id);p()("/editor/"+e.id)}))}handleBtnExportAllDrafts(e){e.preventDefault();const t=JSON.stringify(this.$.drafts),i=document.createElement("a"),o=new Blob([t],{type:"application/octet-stream"});i.href=window.URL.createObjectURL(o),i.download="drafts.json",i.click()}handleAction({detail:e}){switch(e.type){case m.delete:this._deleteDraft(e.id)}}_deleteDraft(e){this._storageService.api.draft.deleteById({id:e}).then(e=>{this.$=Object.assign(Object.assign({},this.$),{drafts:this.$.drafts&&this.$.drafts.filter(t=>t.id!==e.id)})})}};b([Object(o.e)()],w.prototype,"$",void 0),w=b([Object(o.b)("inscriptum-drafts")],w)},365:function(e,t,i){"use strict";i.d(t,"a",(function(){return o})),i.d(t,"b",(function(){return r}));function o(e){if(!document.getElementById(e)){var t=document.getElementsByTagName("head")[0],i=document.createElement("link");i.id=e,i.rel="stylesheet",i.type="text/css",i.href=document.location.origin+e,i.media="all",t.appendChild(i)}}function r(e){let t="<noname>",i="...",o="";if(Array.isArray(null==e?void 0:e.ops)&&e.ops.length>0){t=String(e.ops[0].insert),i=String(e.ops[2].insert);const r=e.ops.find(e=>void 0!==n(e,["insert","blockFigure","image"]));if(null!=r&&(o=n(r,["insert","blockFigure","image"])),i.length<3){for(const[t,r]of e.ops.entries())if(t>2){if(i.length>100)break;void 0!==n(r,["insert","blockFigure","image"])?o=n(r,["insert","blockFigure","image"]):i+=" "+r.insert}i+="..."}}return i=i.trim().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/`/g,"&DiacriticalGrave;").replace(/"/g,"&quot;").replace(/'/g,"&apos;"),{title:t,content:i,image:o}}function n(e,t){return t.reduce((e,t)=>e&&"undefined"!==e[t]?e[t]:void 0,e)}},58:function(e,t){e.exports=".um-drafts__submenu{display:flex;flex-direction:row-reverse;padding-top:10px;border-bottom:1px solid #eee}.um-drafts__export-all{margin:0 0 10px 10px;stroke:#ffffff;stroke-width:30px;color:#bbb}.um-drafts__export-all:hover{color:#888;cursor:pointer}"},72:function(e,t,i){"use strict";i.r(t),i.d(t,"ListComponent",(function(){return h}));var o=i(32),r=i(13),n=i(169),a=i(51),s=i(140),l=i(158),p=i(173),c=i(367),d=i(52),m=function(e,t,i,o){var r,n=arguments.length,a=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var s=e.length-1;s>=0;s--)(r=e[s])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};s.b.add(l.a,p.a);let h=class extends o.a{constructor(){super(a.a,!1),this.styles=r.e`
    <style>
      ${i(133)}
      ${i(134)}
    </style>
  `,this._list=[]}set value(e){void 0!==e&&(this._list=e)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.closePopovers.bind(this))}disconnectedCallback(){document.removeEventListener("click",this.closePopovers.bind(this))}render(){if(this._list.length<1)return r.e``;const e=(e,t=[])=>t.length>0?r.e`
          ...
          `:"",t=Object(n.a)(this._list,e=>e.id,(t,i)=>{var o,n;return r.e`
        <div class="um-drafts__item">
          <h6 class="docs-header">
            ${t.preview.title}
          </h6>
          <div class="row">
            ${(null===(o=t.preview.image)||void 0===o?void 0:o.length)>0?r.e`
            ...
            <div class=${(null===(n=t.preview.image)||void 0===n?void 0:n.length)>0?"ten columns":""}>
              <a class="um-drafts__item-link" href=${t.linkUrl} rel=${Object(c.a)(t.linkRel)}>
                <p class="docs-preview">${Object(d.a)(t.preview.description)}</p>
              </a>
