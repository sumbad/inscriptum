...
(function () {
  ...
  */
  ...
  function aa(a, b, c, d) {
    var e = 0,
      ...
      switch (a[h]) {case 0:
          ...
          b || (b = n(e, 0));b.m++;e++;b.j.push(c[g]);g++;break;case 2:
          b || (b = n(e, 0));
          b.m++;e++;break;case 3:
    ...
    return a === b;
  };var p = window.ShadyDOM || {};p.R = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);var r = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild");p.h = !!(r && r.configurable && r.get);p.H = p.force || !p.R;function t(a) {
  ...
  }var ma = ka("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")),
    ...
    "template" === a.localName && (a = a.content);for (var c = "", d = b ? b(a) : a.childNodes, e = 0, g = d.length, h; e < g && (h = d[e]); e++) {
      a: {
        var f = h;var k = a;var l = b;switch (f.nodeType) {case Node.ELEMENT_NODE:
            for (var m = f.localName, q = "<" + m, z = f.attributes, la = 0; k = z[la]; la++) {
              q += " " + k.name + '="' + k.value.replace(ha, ja) + '"';
            }q += ">";f = ma[m] ? q : q + C(f, l) + "</" + m + ">";break a;case Node.TEXT_NODE:
  ...
  function L(a, b, c) {
    ...
    a.__shady && a.__shady.L || (a.__shady = a.__shady || {}, a.__shady.L = !0, L(a, pa, !0));
  },
      sa = p.h ? function () {} : function (a) {
    a.__shady && a.__shady.J || (a.__shady = a.__shady || {}, a.__shady.J = !0, L(a, J, !0), L(a, qa, !0));
  };function ta(a, b, c) {
  ...
  O.insertBefore = ua;O.removeChild = va;O.setAttribute = wa;O.removeAttribute = xa;O.cloneNode = ya;O.importNode = za;O.addEventListener = Aa;O.removeEventListener = Ba;O.T = Ca;O.U = Da;O.dispatchEvent = Ea;O.querySelector = Fa;O.querySelectorAll = Ga;function P(a, b, c) {
  ...
  function Q(a, b) {
    ...
    if (a.__shady && void 0 !== a.__shady.B) for (var b = a.childNodes, c = 0, d = b.length, e; c < d && (e = b[c]); c++) {
      La(e);
    }a.__shady && (a.__shady.B = void 0);
  }function Ha(a) {
  ...
  function Oa(a) {
    if (a && a.nodeType) {
      a.__shady = a.__shady || {};var b = a.__shady.B;void 0 === b && (u(a) ? b = a : b = (b = a.parentNode) ? Oa(b) : a, document.documentElement.contains(a) && (a.__shady.B = b));return b;
    }
  }function T(a, b, c) {
  ...
  function Qa(a, b, c) {
    ...
    W = !1;for (var a = !!V.length; V.length;) {
      V.shift()();
    }return a;
  }X.list = V;var Ta = {};function Y(a, b, c) {
    if (a !== Ta) throw new TypeError("Illegal constructor");a = document.createDocumentFragment();a.__proto__ = Y.prototype;a.K = "ShadyRoot";N(b);N(a);a.host = b;a.c = c && c.mode;b.__shady = b.__shady || {};b.__shady.root = a;b.__shady.S = "closed" !== a.c ? a : null;a.f = !1;a.b = [];a.a = null;c = D.childNodes(b);for (var d = 0, e = c.length; d < e; d++) {
      O.removeChild.call(b, c[d]);
    }return a;
  }Y.prototype = Object.create(DocumentFragment.prototype);function R(a) {
    a.f || (a.f = !0, Sa(function () {
      return Ua(a);
    }));
  }
  function Ua(a) {
  ...
  Y.prototype._renderRoot = function () {
    this.f = !1;for (var a = 0, b; a < this.b.length; a++) {
      ...
      (c = c.__shady && c.__shady.root) && c.b.length && c._renderRoot();Wa(this, b.__shady.g, b.__shady.assignedNodes);if (c = b.__shady.G) {
        for (d = 0; d < c.length; d++) {
          c[d].__shady.w = null;
        }b.__shady.G = null;c.length > b.__shady.assignedNodes.length && (b.__shady.A = !0);
      }b.__shady.A && (b.__shady.A = !1, Xa(this, b));
      ...
      c = b[a];d = c === this ? this.host : c;e = [];c = c.childNodes;for (var g = 0; g < c.length; g++) {
        ...
        for (f = g[c.index], l = c.index; l < c.index + c.m; l++) {
  ...
  function Va(a, b, c) {
    ...
    for (var d = 0, e; d < c.length && (e = c[d]); d++) {
      "slot" == e.localName ? Wa(a, b, e.__shady.assignedNodes) : b.push(c[d]);
    }
  }
  function Xa(a, b) {
    O.dispatchEvent.call(b, new Event("slotchange"));b.__shady.assignedSlot && Xa(a, b.__shady.assignedSlot);
  }function Ja(a) {
    var b = a.name || a.getAttribute("name") || "__catchall";return a.M = b;
  }function Ka(a) {
    return a.sort(function (a, c) {
      a = Ya(a);for (var b = Ya(c), e = 0; e < a.length; e++) {
  ...
  Y.prototype.addEventListener = function (a, b, c) {
    "object" !== (typeof c === "undefined" ? "undefined" : _typeof(c)) && (c = { capture: !!c });c.v = this;this.host.addEventListener(a, b, c);
  };Y.prototype.removeEventListener = function (a, b, c) {
    "object" !== (typeof c === "undefined" ? "undefined" : _typeof(c)) && (c = { capture: !!c });c.v = this;this.host.removeEventListener(a, b, c);
  };Y.prototype.getElementById = function (a) {
    return T(this, function (b) {
      return b.id == a;
    }, function (a) {
      return !!a;
    })[0] || null;
  };var Za = Y.prototype;L(Za, J, !0);L(Za, K, !0);function $a() {
  ...
  function bb(a, b) {
    a.__shady = a.__shady || {};a.__shady.i || (a.__shady.i = new $a());a.__shady.i.o.add(b);var c = a.__shady.i;return { N: b, P: c, O: a, takeRecords: function takeRecords() {
  ...
  function db(a, b) {
    ...
    drag: !0, dragenter: !0, dragleave: !0, dragover: !0, drop: !0, dragend: !0, DOMActivate: !0, DOMFocusIn: !0, DOMFocusOut: !0, keypress: !0 };function fb(a, b) {
    var c = [],
  ...
  function gb(a, b) {
    if (!u) return a;a = fb(a, !0);for (var c = 0, d, e, g, h; c < b.length; c++) {
      if (d = b[c], g = d === window ? window : d.getRootNode(), g !== e && (h = a.indexOf(g), e = g), !u(g) || -1 < h) return d;
    }
  }
  var hb = { get composed() {
      !1 !== this.isTrusted && void 0 === this.s && (this.s = eb[this.type]);return this.s || !1;
    }, composedPath: function composedPath() {
      this.C || (this.C = fb(this.__target, this.composed));return this.C;
    }, get target() {
      return gb(this.currentTarget, this.composedPath());
    }, get relatedTarget() {
      if (!this.D) return null;this.F || (this.F = fb(this.D, !0));return gb(this.currentTarget, this.F);
  ...
  }var jb = { focus: !0, blur: !0 };function kb(a, b, c) {
  ...
  function lb(a) {
    var b = a.composedPath();Object.defineProperty(a, "currentTarget", { get: function get() {
      ...
      var d = b[c];kb(a, d, "capture");if (a.u) return;
    }Object.defineProperty(a, "eventPhase", { get: function get() {
        return Event.AT_TARGET;
      } });var e;for (c = 0; c < b.length; c++) {
      d = b[c];var g = d.__shady && d.__shady.root;if (0 === c || g && g === e) if (kb(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.u) break;
    }
  }
  ...
  function nb(a, b, c) {
    if (b) {
      ...
      } else d = !!c, g = e = !1;var h = c && c.v || this,
          f = b.l;if (f) {
        if (-1 < mb(f, h, a, d, e, g)) return;
      } else b.l = [];f = function f(d) {
        e && this.removeEventListener(a, b, c);d.__target || ob(d);if (h !== this) {
      ...
      };b.l.push({ node: this, type: a, capture: d, once: e, passive: g, V: f });jb[a] ? (this.__handlers = this.__handlers || {}, this.__handlers[a] = this.__handlers[a] || { capture: [], bubble: [] }, this.__handlers[a][d ? "capture" : "bubble"].push(f)) : (this instanceof Window ? O.T : O.addEventListener).call(this, a, f, c);
    }
  }
  function pb(a, b, c) {
    if (b) {
      if ("object" === (typeof c === "undefined" ? "undefined" : _typeof(c))) {
        ...
        k = b.l;
      } catch (l) {}k && (e = mb(k, h, a, d, e, g), -1 < e && (f = k.splice(e, 1)[0].V, k.length || (b.l = void 0)));(this instanceof Window ? O.U : O.removeEventListener).call(this, a, f || b, c);f && jb[a] && this.__handlers && this.__handlers[a] && (a = this.__handlers[a][d ? "capture" : "bubble"], f = a.indexOf(f), -1 < f && a.splice(f, 1));
    }
  }
  function qb() {
    for (var a in jb) {
    ...
    a.__target = a.target;a.D = a.relatedTarget;if (p.h) {
      var b = Object.getPrototypeOf(a);if (!b.hasOwnProperty("__patchProto")) {
        var c = Object.create(b);c.W = b;x(c, hb);b.__patchProto = c;
      }a.__proto__ = b.__patchProto;
    } else x(a, hb);
  }var rb = ib(window.Event),
      sb = ib(window.CustomEvent),
      tb = ib(window.MouseEvent);function ub(a) {
    var b = a.getRootNode();u(b) && Ua(b);return a.__shady && a.__shady.assignedSlot || null;
  }
  var vb = { addEventListener: nb.bind(window), removeEventListener: pb.bind(window) },
      wb = { addEventListener: nb, removeEventListener: pb, appendChild: function appendChild(a) {
      return P(this, a);
      ...
      var a = this.ownerDocument;if (a && a.contains && a.contains(this) || (a = a.documentElement) && a.contains && a.contains(this)) return !0;for (a = this; a && !(a instanceof Document);) {
        a = a.parentNode || (a instanceof Y ? a.host : void 0);
      }return !!(a && a instanceof Document);
    }, dispatchEvent: function dispatchEvent(a) {
      X();return O.dispatchEvent.call(this, a);
    } },
      xb = { get assignedSlot() {
      return ub(this);
    } },
      yb = { querySelector: function querySelector(a) {
      return T(this, function (b) {
        return ca.call(b, a);
      }, function (a) {
        return !!a;
      ...
      zb = { assignedNodes: function assignedNodes(a) {
      if ("slot" === this.localName) {
        var b = this.getRootNode();u(b) && Ua(b);return this.__shady ? (a && a.flatten ? this.__shady.g : this.__shady.assignedNodes) || [] : [];
      }
    } },
      Ab = y({ setAttribute: function setAttribute(a, b) {
      Qa(this, a, b);
      ...
      return ub(this);
    } }, yb, zb);Object.defineProperties(Ab, qa);var Bb = y({ importNode: function importNode(a, b) {
      return Ra(a, b);
    ...
    } }, yb);Object.defineProperties(Bb, { _activeElement: K.activeElement });
  var Cb = HTMLElement.prototype.blur,
      Db = y({ blur: function blur() {
      var a = this.__shady && this.__shady.root;(a = a && a.activeElement) ? a.blur() : Cb.call(this);
    } });function Z(a, b) {
