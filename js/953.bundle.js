"use strict";(self.webpackChunkinscriptum=self.webpackChunkinscriptum||[]).push([[953,7738,3341,2533],{50953:(t,o,e)=>{e.r(o),e.d(o,{EditorComponent:()=>r});var i=e(93625),n=e(83341),a=e(72533),d=function(t,o,e,i){var n,a=arguments.length,d=a<3?o:null===i?i=Object.getOwnPropertyDescriptor(o,e):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)d=Reflect.decorate(t,o,e,i);else for(var r=t.length-1;r>=0;r--)(n=t[r])&&(d=(a<3?n(d):a>3?n(o,e,d):n(o,e))||d);return a>3&&d&&Object.defineProperty(o,e,d),d};let r=class extends i.UmWebComponent{constructor(){super(n.default,e(97738)),this._isCodeMode=!1,a.PreloaderService.isAppLoading.next(!1)}connectedCallback(){super.connectedCallback(),this.$editorContent=this.querySelector("#editorContent"),this.$editorContent.addEventListener("paste",(function(t){if(t.preventDefault(),null!==t.clipboardData){const o=t.clipboardData&&t.clipboardData.getData("text/plain");document.execCommand("insertHTML",!1,o)}}))}doRichEditCommand(t,o,e){t.preventDefault(),document.execCommand(o,!1,e);const i=window.getSelection();if(i&&i.focusNode){const t=i.focusNode.parentElement;if(t&&"formatBlock"===o)this._formatBlockClasses(e,t)}}switchMode(){this._isCodeMode=!this._isCodeMode,this._setDocMode(this._isCodeMode,this.$editorContent.firstElementChild)}_formatBlockClasses(t,o){if("h2"===t)o.classList.add("entry-title")}_setDocMode(t,o){let e,i=o.innerHTML;if(t){e=document.createTextNode(i),o.innerHTML="";let t=document.createElement("pre");o.contentEditable="false",t.id="sourceText",t.contentEditable="true",t.appendChild(e),o.appendChild(t)}else e=document.createRange(),e.selectNodeContents(o.firstChild),o.innerHTML=e.toString(),o.contentEditable="true"}};r=d([(0,i.Define)("um-editor")],r)},83341:(t,o,e)=>{e.r(o),e.d(o,{default:()=>i});const i=(t,o)=>t`
${o.$style}
...
`},72533:(t,o,e)=>{e.r(o),e.d(o,{PreloaderService:()=>n});var i=e(9248);class n{}n.isAppLoading=new i.x},97738:t=>{t.exports=".the-editor-toolbar{background:#fff;border-bottom:1px solid #f1f1f1;padding:0 9px;box-sizing:border-box}.the-editor-toolbar-button{position:relative;color:#444;padding:0 4px;text-decoration:none;height:40px;line-height:40px;background-color:transparent;margin:0;letter-spacing:0;text-transform:none;text-align:left}.the-editor-toolbar-button:hover{color:#444;background-color:transparent}.the-editor-toolbar-save{float:right}.the-editor-toolbar-has-dropdown{cursor:pointer;position:relative;display:inline-block;padding:0 4px;height:40px;line-height:40px}.the-editor-toolbar-has-dropdown:hover>.the-editor-toolbar-dropdown{display:block}.the-editor-toolbar-dropdown{display:none;position:absolute;left:0;padding:9px;width:220px;background:#fff;border:1px solid #e5e5e5;box-shadow:0px 1px 1px rgba(0,0,0,.04);border-top:none}.the-editor-toolbar-dropdown a{display:block}.the-editor-toolbar-dropdown h1,.the-editor-toolbar-dropdown h2,.the-editor-toolbar-dropdown h3,.the-editor-toolbar-dropdown h4,.the-editor-toolbar-dropdown h5,.the-editor-toolbar-dropdown h6{margin:0;padding:5px 0;width:200px}.the-editor-toolbar-separator{display:inline;margin:0 6px;color:#fff}.the-editor-content{width:100%;min-height:400px;background:#fff;padding:1em}.the-editor-content:focus{outline:none}"}}]);