"use strict";(self.webpackChunkinscriptum=self.webpackChunkinscriptum||[]).push([[953,7738,3341,2533],{953:(t,o,e)=>{e.r(o),e.d(o,{EditorComponent:()=>r});var i=e(3625),n=e(3341),a=e(2533),d=function(t,o,e,i){var n,a=arguments.length,d=a<3?o:null===i?i=Object.getOwnPropertyDescriptor(o,e):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)d=Reflect.decorate(t,o,e,i);else for(var r=t.length-1;r>=0;r--)(n=t[r])&&(d=(a<3?n(d):a>3?n(o,e,d):n(o,e))||d);return a>3&&d&&Object.defineProperty(o,e,d),d};let r=class extends i.UmWebComponent{constructor(){super(n.default,e(7738)),this._isCodeMode=!1,a.PreloaderService.isAppLoading.next(!1)}connectedCallback(){super.connectedCallback(),this.$editorContent=this.querySelector("#editorContent"),this.$editorContent.addEventListener("paste",(function(t){if(t.preventDefault(),null!==t.clipboardData){const o=t.clipboardData&&t.clipboardData.getData("text/plain");document.execCommand("insertHTML",!1,o)}}))}doRichEditCommand(t,o,e){t.preventDefault(),document.execCommand(o,!1,e);const i=window.getSelection();if(i&&i.focusNode){const t=i.focusNode.parentElement;if(t)switch(o){case"formatBlock":this._formatBlockClasses(e,t)}}}switchMode(){this._isCodeMode=!this._isCodeMode,this._setDocMode(this._isCodeMode,this.$editorContent.firstElementChild)}_formatBlockClasses(t,o){switch(t){case"h2":o.classList.add("entry-title")}}_setDocMode(t,o){let e,i=o.innerHTML;if(t){e=document.createTextNode(i),o.innerHTML="";let t=document.createElement("pre");o.contentEditable="false",t.id="sourceText",t.contentEditable="true",t.appendChild(e),o.appendChild(t)}else e=document.createRange(),e.selectNodeContents(o.firstChild),o.innerHTML=e.toString(),o.contentEditable="true"}};r=d([(0,i.Define)("um-editor")],r)},3341:(t,o,e)=>{e.r(o),e.d(o,{default:()=>i});const i=(t,o)=>t`
${o.$style}
