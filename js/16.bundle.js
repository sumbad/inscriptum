(window.webpackJsonp=window.webpackJsonp||[]).push([[16,49,70,103],{1203:function(t,o){t.exports=".the-editor-toolbar{background:#fff;border-bottom:1px solid #f1f1f1;padding:0 9px;box-sizing:border-box}.the-editor-toolbar-button{position:relative;color:#444;padding:0 4px;text-decoration:none;height:40px;line-height:40px;background-color:transparent;margin:0;letter-spacing:0;text-transform:none;text-align:left}.the-editor-toolbar-button:hover{color:#444;background-color:transparent}.the-editor-toolbar-save{float:right}.the-editor-toolbar-has-dropdown{cursor:pointer;position:relative;display:inline-block;padding:0 4px;height:40px;line-height:40px}.the-editor-toolbar-has-dropdown:hover>.the-editor-toolbar-dropdown{display:block}.the-editor-toolbar-dropdown{display:none;position:absolute;left:0;padding:9px;width:220px;background:white;border:1px solid #e5e5e5;box-shadow:0px 1px 1px rgba(0,0,0,0.04);border-top:none}.the-editor-toolbar-dropdown a{display:block}.the-editor-toolbar-dropdown h1,.the-editor-toolbar-dropdown h2,.the-editor-toolbar-dropdown h3,.the-editor-toolbar-dropdown h4,.the-editor-toolbar-dropdown h5,.the-editor-toolbar-dropdown h6{margin:0;padding:5px 0;width:200px}.the-editor-toolbar-separator{display:inline;margin:0 6px;color:#fff}.the-editor-content{width:100%;min-height:400px;background:white;padding:1em}.the-editor-content:focus{outline:none}\n"},50:function(t,o){var e;e=function(){return this}();try{e=e||new Function("return this")()}catch(t){"object"==typeof window&&(e=window)}t.exports=e},562:function(t,o,e){"use strict";e.r(o),e.d(o,"PreloaderService",function(){return n});var i=e(203);class n{}n.isAppLoading=new i.Subject},760:function(t,o,e){"use strict";e.r(o),e.d(o,"EditorComponent",function(){return r});e(648);var i=e(550),n=e(951),a=e(562);let r=class extends i.UmWebComponent{constructor(){super(n.default,e(1203)),this._isCodeMode=!1,a.PreloaderService.isAppLoading.next(!1)}connectedCallback(){super.connectedCallback(),this.$editorContent=this.querySelector("#editorContent"),this.$editorContent.addEventListener("paste",function(t){t.preventDefault();var o=t.clipboardData.getData("text/plain");document.execCommand("insertHTML",!1,o)})}doRichEditCommand(t,o,e){t.preventDefault(),document.execCommand(o,!1,e);const i=window.getSelection().focusNode.parentElement;if(i)switch(o){case"formatBlock":this._formatBlockClasses(e,i)}}switchMode(){this._isCodeMode=!this._isCodeMode,this._setDocMode(this._isCodeMode,this.$editorContent.firstElementChild)}_formatBlockClasses(t,o){switch(t){case"h2":o.classList.add("entry-title")}}_setDocMode(t,o){let e,i=o.innerHTML;if(t){e=document.createTextNode(i),o.innerHTML="";let t=document.createElement("pre");o.contentEditable="false",t.id="sourceText",t.contentEditable="true",t.appendChild(e),o.appendChild(t)}else(e=document.createRange()).selectNodeContents(o.firstChild),o.innerHTML=e.toString(),o.contentEditable="true"}};r=function(t,o,e,i){var n,a=arguments.length,r=a<3?o:null===i?i=Object.getOwnPropertyDescriptor(o,e):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,o,e,i);else for(var d=t.length-1;d>=0;d--)(n=t[d])&&(r=(a<3?n(r):a>3?n(o,e,r):n(o,e))||r);return a>3&&r&&Object.defineProperty(o,e,r),r}([Object(i.Define)("um-editor")],r)},951:function(t,o,e){"use strict";e.r(o),o.default=((t,o)=>t`
${o.$style}
