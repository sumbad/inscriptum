(window.webpackJsonp=window.webpackJsonp||[]).push([[12,40,41,74],{528:function(t,o,e){"use strict";e.r(o),e.d(o,"PreloaderService",function(){return n});var i=e(201);class n{}n.isAppLoading=new i.Subject},604:function(t,o,e){"use strict";e.r(o),e.d(o,"EditorComponent",function(){return d});e(550);var i=e(522),n=e(627),a=e(528);let d=class extends i.UmWebComponent{constructor(){super(n.default,e(723)),this._isCodeMode=!1,a.PreloaderService.isAppLoading.next(!1)}connectedCallback(){super.connectedCallback(),this.$editorContent=this.querySelector("#editorContent"),this.$editorContent.addEventListener("paste",function(t){t.preventDefault();var o=t.clipboardData.getData("text/plain");document.execCommand("insertHTML",!1,o)})}doRichEditCommand(t,o,e){t.preventDefault(),document.execCommand(o,!1,e);const i=window.getSelection().focusNode.parentElement;if(i)switch(o){case"formatBlock":this._formatBlockClasses(e,i)}}switchMode(){this._isCodeMode=!this._isCodeMode,this._setDocMode(this._isCodeMode,this.$editorContent.firstElementChild)}_formatBlockClasses(t,o){switch(t){case"h2":o.classList.add("entry-title")}}_setDocMode(t,o){let e,i=o.innerHTML;if(t){e=document.createTextNode(i),o.innerHTML="";let t=document.createElement("pre");o.contentEditable="false",t.id="sourceText",t.contentEditable="true",t.appendChild(e),o.appendChild(t)}else(e=document.createRange()).selectNodeContents(o.firstChild),o.innerHTML=e.toString(),o.contentEditable="true"}};d=function(t,o,e,i){var n,a=arguments.length,d=a<3?o:null===i?i=Object.getOwnPropertyDescriptor(o,e):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)d=Reflect.decorate(t,o,e,i);else for(var r=t.length-1;r>=0;r--)(n=t[r])&&(d=(a<3?n(d):a>3?n(o,e,d):n(o,e))||d);return a>3&&d&&Object.defineProperty(o,e,d),d}([Object(i.Define)("um-editor")],d)},627:function(t,o,e){"use strict";e.r(o),o.default=((t,o)=>t`
${o.$style}
